 ...
 * @todo       
 */
class User_AppServer extends YLB_Model
{
    public $_cacheKeyPrefix  = 'c|user_app_server|';
    public $_cacheName       = 'user';
    public $_tableName       = 'user_app_server';
     ...
     * @access public
     */
    public function getAppServer($user_name=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function editAppServer($user_name=null, $field_row)
    {
     ...
     * @access public
     */
    public function editAppServerSingleField($user_name, $field_name, $field_value_new, $field_value_old)
    {
     ...
     * @access public
     */
    public function removeAppServer($user_name)
    {
