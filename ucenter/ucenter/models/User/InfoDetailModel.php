...
class User_InfoDetailModel extends User_InfoDetail
{
     ...
     * @return array
     */
    public function checkMobileII($mobile=null)
    {
        $data = $this->getKeyByWhere(array('user_mobile'=>$mobile));
        return $data;
    }
	...
	public function sync($user_id)
	{
		...
		if ($user_id)
		{
			...
			if ($user_row)
			{
                ...
                $edit_user_row['user_avatar']     = $user_info_row['user_avatar'] ? $user_info_row['user_avatar'] : Web_ConfigModel::value('user_default_avatar', YLB_Registry::get('static_url') . '/images/default_user_portrait.png');;
