 ...
 * @todo       
 */
class User_InfoDetail extends YLB_Model
{
    ...
    public function getInfoDetail($user_name=null, $sort_key_row=null)
    {
		...
		{
			$rows[$k]['user_avatar']     = $row['user_avatar'] ? $row['user_avatar'] : Web_ConfigModel::value('user_default_avatar', YLB_Registry::get('static_url') . '/images/default_user_portrait.png');
		}
