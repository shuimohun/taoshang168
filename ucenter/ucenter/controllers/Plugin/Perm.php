...
class Plugin_Perm implements YLB_Plugin_Interface
{
    ...
    public function checkPerm()
    {
		...
		//无需权限判断的文件
		$not_perm = array('Login', 'Api', 'ImApi', 'Index', 'Connect_Qq', 'Connect_Weixin', 'Connect_Weibo','Connect', 'Upload', 'OAuth2', 'Base_AppVersion');
        ...
        else
        {
			...
			if ('e' == $_REQUEST['typ'])
			{
				$url = YLB_Registry::get('url') . '?ctl=Login&met=index&typ=e';
