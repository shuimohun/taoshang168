...
//		$user_qq = request_string('user_qq');
    ...
    {
        $userDetailModel = new User_InfoDetailModel();
//        $sql = "select * from ucenter_user_info_detail";
//        $field = $cond_row['field'];
//        $cond['user_reg_time:>='] =  $cond_row['user_reg_time:>='] ;
//        $cond['user_reg_time:<']  =  $cond_row['user_reg_time:<'];
//        $group = $cond_row['group'];
//        $data = $userDetailModel->sql($sql);
//        $data = $userDetailModel->select($field,$cond,$group);
//        $data['field'] = $cond_row;
        $data['field'] 	= request_string('field');
//        $cond['user_reg_time:>='] =  $cond_row['user_reg_time:>='] ;
//        $cond['user_reg_time:<']  =  $cond_row['user_reg_time:<'];
//        $group = $cond_row['group'];
//   var_dump($data);die;
