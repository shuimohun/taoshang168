...
//var property_format_row = [{"id":"select","name":"select"},{"id":"checkbox","name":"checkbox"},{"id":"text","name":"text"}];
var property_format_row = [{"id":"select","name":"select"},{"id":"text","name":"text"}];
...
function initField()
{
    ...
    if (rowData.id)
    {
        ...
        if(rowData.property_is_display==1)
        {
            $('#property_is_display1').attr('checked', true);
            $('#property_is_display0').attr('checked', false);
            $('[for="property_is_display1"]').addClass('selected');
            $('[for="property_is_display0"]').removeClass('selected');
        }
        else
        {
            $('#property_is_display1').attr('checked', false);
            $('#property_is_display0').attr('checked', true);
            $('[for="property_is_display1"]').removeClass('selected');
            $('[for="property_is_display0"]').addClass('selected');
        }
...
function postData(t, e)
{
    var property_name = $.trim($("#property_name").val()),
        ...
        property_is_display = $("input[name='property_is_display']:checked").val();
    ...
    params = rowData.property_id ? {
        ...
        property_is_display: property_is_display,
