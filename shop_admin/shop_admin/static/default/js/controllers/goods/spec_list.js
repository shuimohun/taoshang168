$(function() {
    ...
    var handle = {
        ...
        operFormatter: function(val, opt, row) {
            ...
            {
                var html_con = '<div class="operating" data-id="' + row.id + '"><span class="ui-icon ui-icon-pencil ui-icon-disabled" title="修改"></span><span class="ui-icon ui-icon-trash  ui-icon-disabled" title="删除"></span></div>';
            }
            else
            {
    ...
    function initEvent() {
        ...
        $('#search').on('click', function(e) {
            e.preventDefault();
            var skey = spec_name.val() === '输入规格名称' ? '' : $.trim(spec_name.val());
