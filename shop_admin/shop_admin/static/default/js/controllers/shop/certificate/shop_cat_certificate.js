...
function initGrid()
{
    var t = ["操作", "商品分类"], e = [{
        ...
        {name: "cat_name", index: "cat_name", width:200,align:"center"},
    ];

    $("#grid").jqGrid({
        url: SITE_URL + "?ctl=Shop_Certificate&met=catCertificateIndex&typ=json",
        datatype: "json",
        ...
        rowList: [25, 50, 100],
        shrinkToFit: !1,
        jsonReader: {root: "data.items", records: "data.records", total: "data.total", repeatitems: !1, id: "cat_id"},
...
var handle = {
    operate: function (t, e)
    {
        ...
        $.dialog({
            title: i,
            content: 'url:'+SITE_URL + "?ctl=Shop_Certificate&met=certificateManage",
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Shop_Certificate&met=removeCatCertificate&typ=json", {id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
