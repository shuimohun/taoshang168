...
function initGrid()
{
     ...
     var t = ["操作","分类名称", "保证金", "排序","关联分类"], e = [
         ...
         {name: "shop_class_name", index: "shop_class_name",  align: "center",width: 200},
         {name: "shop_class_deposit", index: "shop_class_deposit", align: "center",width: 100},
         {name: "shop_class_displayorder", index: "shop_class_displayorder", align: "center",width: 100},
         {name: "goods_cat_name", index: "goods_cat_name", align: "center",width: 200}
        ];
	$("#grid").jqGrid({
