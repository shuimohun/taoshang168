...
var queryConditions = {"otyp":urlParam.otyp,'recheck':urlParam.otyp},
		hiddenAmount = false, 
...
if(urlParam.otyp==1 || urlParam.otyp==3){
	var cols = [
        ...
        {name:'return_platform_add_time', label:'申诉时间',  width:150, align:"center",sortable:true},
		{name:'return_reason', label:'退款原因',  width:300, align:"center"},
		{name:'return_add_time', label:'退款时间',  width:150, align:"center",sortable:true},
	...
	var cols = [
		...
		{name:'return_commision_fee', label:'佣金金额',  width:100, align:"center",sortable:true},
        {name:'return_platform_add_time', label:'申诉时间',  width:150, align:"center",sortable:true},
		{name:'return_reason', label:'退货原因',  width:300, align:"center"},
		{name:'return_add_time', label:'退货时间',  width:150, align:"center",sortable:true},
	...
	var THISPAGE = {
		...
		loadGrid: function(){
			...
			$("#grid").jqGrid({
				...
				page: 1, 
				sortname: 'return_platform_add_time',
				sortorder: "desc", 
				pager: "#page",  
				rowNum: 25,
				rowList: [25, 50, 100],
