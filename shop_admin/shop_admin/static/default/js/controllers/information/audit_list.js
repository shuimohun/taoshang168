...
function initGrid() {
    var t = ["操作", "标题", "作者", "真实阅读量", "虚拟阅读量", "添加时间", "审核状态"],
        e = [{
            name: "operate",
            width: 60,
            fixed: !0,
            ...
            name: "information_state_con",
            index: "information_state_con",
            width: 150
        }];
    ...
    $("#grid").jqGrid({
        url: SITE_URL + "?ctl=Information_Base&met=getAuditList&typ=json",
        datatype: "json",
...
var handle = {
    operate: function(t, e) {
        if ("edit" == t) {
            var i = "审核", a = {oper: t, rowData: $("#grid").data("gridData")[e], callback: this.callback};
        }
        $.dialog({
            title: i,
            content: 'url:'+SITE_URL + "?ctl=Information_Base&met=auditManage&information_id="+e,
            width: 500,
            height: 300,
            data: a,
            max: !1,
