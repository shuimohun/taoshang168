...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'waybill_tpl_name', label:'模板名称', width:120, align:"center"},
         
            {name:'express_name', label:'快递公司', width:100,align:'center'},
            {name:'waybill_tpl_image', label:'运单图例', width:150,align:'center',"formatter": handle.imgFmt ,classes:'img_flied'},
            ...
            /*新加*/
            {name:'waybill_tpl_electronicimage', label:'电子运单图例', width:150,align:'center',"formatter": handle.imgFmt ,classes:'img_flied'},
             {name:'waybill_tpl_electronicwidth', label:'电子宽度(mm)', width:100, align:"center"},
            {name:'waybill_tpl_electronicheight', label:'电子高度(mm)', width:100, align:"center"},
             {name:'waybill_tpl_electronicenable', label:'电子是否启用', width:100, align:"center"},
            {name:'waybill_tpl_electronictop', label:'电子上偏移', width:100, align:"center"},
            {name:'waybill_tpl_electronicleft', label:'电子左偏移', width:100, align:"center"},
