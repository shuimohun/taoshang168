...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        $("#grid").jqGrid({
            url:SITE_URL + "?ctl=Operation_Contract&met=getContractStateList&typ=json"+type,
		...
		function operFmatter (val, opt, row) {
		    if(row.contract_log_state == '3'){
                var html_con = '<div class="operating" data-id="' + row.id + '"><span class="ui-icon ui-icon-pencil ui-icon-disabled" title="查看"></span></div>';
            }else {
