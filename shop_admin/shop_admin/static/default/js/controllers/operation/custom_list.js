...
var THISPAGE = {
    ...
    loadGrid: function(){
		...
		{name: "custom_service_question", label: "咨询内容", align:"left",width:380,sortable:false},
		{name: "user_account", label: "咨询人", align: "center",width: 100,sortable:false},
		{name: "custom_service_question_time", label: "咨询时间", align: "center",width: 150,sortable:true},
		{name: "custom_service_status_text", label: "咨询状态", align: "center",width:100,sortable:false}
        ];
        this.mod_PageConfig.gridReg('grid', colModel);
        colModel = this.mod_PageConfig.conf.grids['grid'].colModel;
        $("#grid").jqGrid({
            url:SITE_URL + "?ctl=Operation_Custom&met=getCustomList&typ=json"+type,
