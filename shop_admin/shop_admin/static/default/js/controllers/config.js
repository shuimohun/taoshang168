$(function() {
    if ($('#discount-slider-form').length > 0) {
        $('#discount-slider-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('确认修改吗？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#discount-slider-form').serialize(), function(res) {
                        if (res.status == 200) {
                            parent.Public.tips({
                                content: '修改成功!'
                            });
...
//惠抢购
$(function() {
    if ($('#scarebuy-setting-form').length > 0) {
        $('#scarebuy-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            fields: {
                'scarebuy[scarebuy_price]': 'required;integer[+0];',
                'scarebuy[scarebuy_review_day]': 'required;integer[+0];'
            },
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#scarebuy-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//优惠套餐
$(function() {
    if ($('#bundling-form').length > 0) {
        $('#bundling-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            fields: {
                'bundling[promotion_bundling_price]': 'required;integer[+0];'
            },
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#bundling-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//新人优惠
$(function() {
    if ($('#newbuyer-form').length > 0) {
        $('#newbuyer-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            fields: {
                'newbuyer[promotion_newbuyer_price]': 'required;integer[+0];'
            },
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#newbuyer-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
$(function() {
    if ($('#fu-form').length > 0) {
        $('#fu-form').validator({
            ...
            stopOnError: true,
            fields: {
                'fu[promotion_fu_price]': 'required;integer[+0];'
            },
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#fu-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 惠抢购
$(function() {
    if ($('#sc-setting-form').length > 0) {
        $('#sc-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#sc-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 自营超市
$(function() {
    if ($('#sf-setting-form').length > 0) {
        $('#sf-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#sf-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 生鲜特产
$(function() {
    if ($('#sx-setting-form').length > 0) {
        $('#sx-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#sx-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 新人专享
$(function() {
    if ($('#newbuyer-setting-form').length > 0) {
        $('#newbuyer-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#newbuyer-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 9.9
$(function() {
    if ($('#jiu-setting-form').length > 0) {
        $('#jiu-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#jiu-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 劲爆折扣
$(function() {
    if ($('#zk-setting-form').length > 0) {
        $('#zk-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#zk-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 排行榜
$(function() {
    if ($('#paihang-setting-form').length > 0) {
        $('#paihang-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#paihang-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 红包
$(function() {
    if ($('#hongbao-setting-form').length > 0) {
        $('#hongbao-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#hongbao-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 遇见好货
$(function() {
    if ($('#yujianhaohuo-setting-form').length > 0) {
        $('#yujianhaohuo-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#yujianhaohuo-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 家有儿女
$(function() {
    if ($('#ernv-setting-form').length > 0) {
        $('#ernv-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#ernv-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 每日必buy
$(function() {
    if ($('#meiri-setting-form').length > 0) {
        $('#meiri-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#meiri-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//seo设置 发现好店
$(function() {
    if ($('#findshop-setting-form').length > 0) {
        $('#findshop-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#findshop-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//自营超市幻灯
$(function() {
    if ($('#self_slider-setting-form').length > 0) {
        $('#self_slider-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#self_slider-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//自营超市首页幻灯片
$(function() {
    if ($('#self_index-setting-form').length > 0) {
        $('#self_index-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#self_index-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//自营超市首页小图
$(function() {
    if ($('#self_index_img-setting-form').length > 0) {
        $('#self_index_img-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#self_index_img-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//生鲜特产首页幻灯片
$(function() {
    if ($('#fresh_index-setting-form').length > 0) {
        $('#fresh_index-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#fresh_index-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//生鲜特产首页小图
$(function() {
    if ($('#fresh_index_img-setting-form').length > 0) {
        $('#fresh_index_img-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#fresh_index_img-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//开业模板提交
$(function() {
    if ($('#opening_goods-setting-form').length > 0) {
        $('#opening_goods-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Operation_Opening&met=upHeadImage&typ=json', $('#opening_goods-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
//开业设置提交
$(function() {
    if ($('#opening_setting-setting-form').length > 0) {
        $('#opening_setting-setting-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            ...
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', $('#opening_setting-setting-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
...
$(function() {
    if ($('#activity-setting-form').length > 0) {
        $('#activity-setting-form').on("click", "a.submit-btn", function(e) {

            parent.$.dialog.confirm('修改立马生效,是否继续？', function() {
                Public.ajaxPost(SITE_URL + '?ctl=Operation_Acsetting&met=editSetting&typ=json',$('#activity-setting-form').serialize(),function(data) {
                    if (data.status == 200) {
                        parent.Public.tips({
                            content: '修改操作成功！'
                        });
...
//资讯金蛋设置
$(function() {
    if ($('#information-form').length > 0) {
        $('#information-form').validator({
            ignore: ':hidden',
            theme: 'yellow_bottom',
            timely: 1,
            stopOnError: true,
            fields: {
                'information[eggs_allow]': 'required;integer[+0];',
                'information[verify_allow]': 'required;integer[+0];',
                'information[post]': 'required;integer[+];',
                'information[author_post_top]': 'required;integer[+];',
                'information[recommend1]': 'required;integer[+];',
                'information[recommend2]': 'required;integer[+];',
                'information[recommend3]': 'required;integer[+];',
                'information[recommend4]': 'required;integer[+];',
                'information[be_liked]': 'required;integer[+];',
                'information[be_followed]': 'required;integer[+];',
                'information[be_forwarded]': 'required;integer[+];',
                'information[author_top]': 'required;integer[+];',
                'information[no_pass]': 'required;integer[+];',
                'information[report1]': 'required;integer[+];',
                'information[report2]': 'required;integer[+];',
                'information[report3]': 'required;integer[+];',
                'information[report4]': 'required;integer[+];',
                'information[read]': 'required;integer[+];',
                'information[like]': 'required;integer[+];',
                'information[follow]': 'required;integer[+];',
                'information[forward]': 'required;integer[+];',
                'information[reader_top]': 'required;integer[+];',
                'information[report]': 'required;integer[+];',
                'information[illegal_report]': 'required;integer[+];',
            },
            valid: function(form) {
                parent.$.dialog.confirm('修改立马生效,是否继续？', function() {

                    var report1 = '1-' + $('input[name=report1_day]').val() + '-' + $('input[name=report1_points]').val();
                    var report2 = '1-' + $('input[name=report2_day]').val() + '-' + $('input[name=report2_points]').val();
                    var report3 = '2-' + $('input[name=report3_day]').val() + '-' + $('input[name=report3_points]').val();
                    var report4 = '2-n-' + $('input[name=report4_points]').val();
                    var param = '&information[report1]=' + report1 + '&information[report2]=' + report2 +'&information[report3]=' + report3 +'&information[report4]=' + report4 +'&';

                    Public.ajaxPost(SITE_URL + '?ctl=Config&met=edit&typ=json', param + $('#information-form').serialize(), function(data) {
                        if (data.status == 200) {
                            parent.Public.tips({
                                content: '修改操作成功！'
                            });
