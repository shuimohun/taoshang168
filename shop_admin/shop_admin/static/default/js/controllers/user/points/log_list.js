...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'points_log_id', label:'金蛋id', width:100, align:"center"},
         
            {name:'user_id', label:'会员id', width:100,align:'center'},
            {name:'user_name', label:'会员名称', width:200,align:'center'},
            {name:'points_log_points', label:'金蛋', width:100, align:"center"},
            {name:'points_log_time', label:'操作时间', width:200, align:"center"},
            {name:'points_log_desc', label:'操作描述', width:200, align:"center"},
            {name:'admin_name', label:'管理员名称', width:200, align:"center"}
