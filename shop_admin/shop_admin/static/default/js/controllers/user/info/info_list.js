...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'user_birthday', label:'出生日期', width:150, align:"center"},
            {name:'user_regtime', label:'注册时间', width:150, align:"center"},
            {name:'shop_type', label:'商家类型', width:100, align:"center","formatter":shop_type},
            {name:'lastlogintime', label:'最后登录时间', width:150, align:"center"}
           
        ];
        this.mod_PageConfig.gridReg('grid', colModel);
        colModel = this.mod_PageConfig.conf.grids['grid'].colModel;
        $("#grid").jqGrid({
            url:SITE_URL +  '?ctl=User_Info&met=getInfoList&typ=json'+type,
