...
function initGrid()
{
    var t = ["店铺名称", "开始时间","结束时间"],
        e = [
            ...
            {name: "quota_starttime", index: "quota_stattime",align: "center",width: 150},
            {name: "quota_endtime", index: "quota_endtime",align: "center",width: 150}
        ];

    $("#grid").jqGrid({
        url: SITE_URL + '?ctl=Promotion_NewBuyer&met=getQuotaList&typ=json',
        datatype: "json",
        ...
        rowList: [25, 50, 100],
        shrinkToFit: !1,
        jsonReader: {root: "data.items", records: "data.records", total: "data.total", repeatitems: !1, id: "quota_id"},
