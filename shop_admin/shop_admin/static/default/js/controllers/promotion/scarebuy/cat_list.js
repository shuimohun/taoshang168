var handle = {
    ...
    operate: function (oper, row_id)
    {
        ...
        {
            var title = sprintf(_('编辑分类 [%s]'), $("#grid").data('gridData')[row_id]['scarebuy_cat_name']);
            var data = {
                oper: oper,
                rowId: row_id,
        ...
        $.dialog({
            title: title,
            content: 'url:' + SITE_URL + '?ctl=Promotion_ScareBuy&met=' + met + '&typ=e',
            data: data,
            max: false,
            min: false,
            cache: false,
    ...
    del: function (row_ids)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + '?ctl=Promotion_ScareBuy&met=removeScareBuyCat&typ=json', {
                scarebuy_cat_id: row_ids
            }, function (data)
            {
...
var colModel = [{
    ...
    "name": "scarebuy_cat_name",
    "index": "scarebuy_cat_name",
    "label": "分类名称",
    "classes": "ui-ellipsis",
    "align": "left",
    "title": false,
    ...
    "name": "scarebuy_cat_type_label",
    "index": "scarebuy_cat_type_label",
    "label": "分类类型",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
    ...
    "name": "scarebuy_cat_sort",
    "index": "scarebuy_cat_sort",
    "label": "排序",
    "classes": "ui-ellipsis",
    "align": "center",
    "title": false,
...
jQuery(document).ready(function ($)
{
    ...
    {
        $("#grid").jqGrid({
            url: SITE_URL + '?ctl=Promotion_ScareBuy&met=getCat&typ=json&is_delete=2',
            datatype: "json",
            autowidth: true,
            shrinkToFit: false,
            forceFit: true,
            ...
            scrollrows: true,
            treeGrid: true,
            ExpandColumn: "scarebuy_cat_name",
            treedatatype: "json",
            ...
            loadComplete: function(response) {
                if (response && response.status == 200) {
                    ...
                    for (var i = 0; i < data.items.length; i++) {
                        ...
                        item['id'] = item.scarebuy_cat_id;
                        gridData[item.scarebuy_cat_id] = item;
                    }
            ...
            "treeReader": {
                "parent_id_field": "scarebuy_cat_parent_id",
