            ...
            success: function(data) {
                ...
                if (data && data['items'].length > 0) {
                    ...
                    for (i = 0; i < items.length; i++) {
                        $imageUl.append('<li class="image-item js-image-item" data-id="' + items[i].upload_id + '">' + '<div class="image-box" style="background-image: url(' + items[i].upload_path + ')"></div>' + '<div class="image-meta">600*400</div>' + '<div class="image-title">' + items[i].upload_name + items[i].upload_mime_type + '</div>' + '</li>')
                    }
                    /*if (data.total > 2)
                     {
