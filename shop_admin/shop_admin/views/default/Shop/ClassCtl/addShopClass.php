...
<body>
        <form method="post" enctype="multipart/form-data" id="shop_edit_class" name="form1">
          <input  name="shop_class_id" value=""  type="hidden"/>
        <div class="ncap-form-default">
              <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_class_name" name="shop_class_name" value="" class="ui-input w200" type="text"/>
                </dd>
              </dl>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_class_deposit"  name="shop_class_deposit" value="" class="ui-input w200" type="text"/>
                </dd>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_class_displayorder" name="shop_class_displayorder"  value="" class="ui-input w200" type="text"/>
                </dd>
...
function postData(t, e)
{
	...
	$_form.validator({
            ...
            fields: {
                ...
                'shop_class_displayorder':'required;integer[+0];' 
            },
