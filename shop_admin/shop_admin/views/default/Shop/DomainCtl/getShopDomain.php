...
<body>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_sub_domain" name="shop_sub_domain"  value="<?=$value['shop_sub_domain']?>" class="ui-input w200" type="text"/>
                </dd>
...
function postData(t, e)
{
	...
	$_form.validator({
         rules: {
          domainz:[/^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$/ , '请填写正确域名'],
        },
           messages: {
                    required: "请填写该字段",
