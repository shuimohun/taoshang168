    ...
    <div class="item-title">
      <div class="subject">
        ...
        <h5>店铺的审核续费及经营类目结算周期操作</h5>
		  ...
		  <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span>审核开店信息</span></a></li>
                  <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Shop_Manage&met=shopPay" ><span>审核店铺付款</span></a></li>
