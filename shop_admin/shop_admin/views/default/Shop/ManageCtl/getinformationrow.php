...
<body>
    ...
    <script>
        ...
        var shop_class_id =  <?= $data['default_shop_class_id'] ?>;
        var class_row = <?= encode_json($data['class']) ?>;
        var shop_grade_id =  <?= $data['default_shop_grade_id'] ?>;
        var grade_row = <?= encode_json($data['grade']) ?>;
        ...
        function postData(t, e) {
            $_form.validator({
                ...
                valid: function(form) {
                    var shop_id = $.trim($("#shop_id").val()),
                        shop_name = $.trim($("#shop_name").val()),
                        shop_class_id = $.trim($class.getValue()),
                        shop_grade_id = $.trim($grade.getValue()),
