        ...
        foreach ($data['base'] as $key => $value) {
            if(!empty($value['shop_company_name']) && $value['shop_business']){
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    ...
                    <tbody>
                    <tr>
                        <th class="w150">营业执照类型：</th>
                        <td><?=$value['shop_license_type_name']?></td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    ...
                    <tbody>
                    <tr>
                        <th class="w150">纳税人类型：</th>
                        <td><?=$value['taxpayer_type_name']?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>税务登记证号<br />
                            电子版：</th>
                        <td>
                            <a nctype="nyroModal"  href="<?=$value['tax_registration_certificate_electronic']?>" target="_blank">
                                <img src="<?=$value['tax_registration_certificate_electronic']?>" alt="" />
                            </a>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    <thead>
                    <tr>
                        <th colspan="20">店铺管理人员资料</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($value['shop_manage_title_map'] as $k=>$v){?>
                        <tr>
                            <th class="w150"><?=$v?>：</th>
                            <td>
                                <?php foreach ($value['shop_manage_content_map'] as $k2 => $v2){?>
                                    <?=$v2?>:<?=isset($value['shop_manage'])&&isset($value['shop_manage'][$k])&&isset($value['shop_manage'][$k][$k2])?$value['shop_manage'][$k][$k2]:''?>
                                <?php }?>
                            </td>
                        </tr>
                    <?php }?>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    <thead>
                        <tr>
                            <th colspan="20">授权书</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <th class="w150">品牌类型：</th>
                            <td><?=$value['band_type_name']?></td>
                        </tr>
                        <?php if($value['band_type'] == 1){?>
                            <tr>
                                <th>自营品牌名称：</th>
                                <td><?=$value['self_owned']?></td>
                            </tr>
                            <tr>
                                <th>品牌商标电子版：</th>
                                <td>
                                    <a href="<?=$value['self_owned_band']?>" target="_blank">
                                        <img src="<?=$value['self_owned_band']?>" alt="" />
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <th>品牌授权书电子版：</th>
                                <td>
                                    <a href="<?=$value['self_owned_authorization']?>" target="_blank">
                                        <img src="<?=$value['self_owned_authorization']?>" alt="" />
                                    </a>
                                </td>
                            </tr>
                        <?php }else if($value['band_type'] == 2){?>
                            <tr>
                                <th>代理品牌授权书：</th>
                                <td><?=$value['agency_brand_licensing']?></td>
                            </tr>
                            <tr>
                                <th>公司所在地：</th>
                                <td><?=$value['agency_bank_address']?><br /> <?=$value['agency_band_address_detail']?></td>
                            </tr>
                            <tr>
                                <th>公司电话：</th>
                                <td><?=$value['band_company_tel']?></td>
                            </tr>
                            <tr>
                                <th>代理品牌授权书效期：</th>
                                <td><?=date('Y-m-d',strtotime($value['band_start_time']))?>&nbsp;&nbsp;-&nbsp;&nbsp;<?=date('Y-m-d',strtotime($value['band_end_time']))?></td>
                            </tr>

                            <tr>
                                <th>品牌系委托他人生产：</th>
                                <td><?=$value['band_pro_type_name']?></td>
                            </tr>

                            <?php if($value['band_pro_type']){?>
                                <tr>
                                    <th>委托加工协议：</th>
                                    <td>
                                        <a href="<?=$value['band_pro_agreement']?>" target="_blank">
                                            <img src="<?=$value['band_pro_agreement']?>" alt="" />
                                        </a>
                                    </td>
                                </tr>
                            <?php }?>
                ...
                <form id="form_store_verify" action="index.php?act=store&op=store_joinin_verify" method="post">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                        ...
                        <?php foreach ($value['cer_data'] as $k=>$v){?>
                            <?php if($value['certificate_type'] == '0' && $v['type'] == '1'){?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($v['is_defect']){?>
                                        <span style="color:#FF4564;">缺失</span>
                                    <?php }else{?>
