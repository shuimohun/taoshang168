    ...
    <form method="post" enctype="multipart/form-data" id="form1" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <select id="type" name="type">
                        <option value="0" <?php if($data['type'] == '0'){echo 'selected';}?>>国内</option>
                        <option value="1" <?php if($data['type'] == '1'){echo 'selected';}?>>进口</option>
                    </select>
                </dd>
            </dl>
            <dl class="row">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="display_order" name="display_order" value="<?=$data["display_order"]?>" class="ui-input w200" type="text"/>
                </dd>
            </dl>
        </div>
    </form>
        ...
        function initPopBtns() {
            ...
            api.button({
                ...
                callback: function() {
                    ...
                    return cancleGridEdit(), $("#form1").trigger("validate"), !1
                }
            }, {
                id: "cancel",
                name: t[1]
