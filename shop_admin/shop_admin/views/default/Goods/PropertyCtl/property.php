...
<form method="post" name="manage-form" id="manage-form" action="">
    <input type="hidden" name="user_id" class="user_id" value='<?=Perm::$userId?>' />
    <div class="ncap-form-default">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
                    <label for="property_is_display1" class="cb-enable  ">是</label>
                    <label for="property_is_display0" class="cb-disable  selected">否</label>
                    <input id="property_is_display1"  name ="property_is_display"  value="1" type="radio">
                    <input id="property_is_display0"  name ="property_is_display"  checked="checked"  value="0" type="radio">
                </div>
            </dd>
        </dl>
        <dl class="row">
