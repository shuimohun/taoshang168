	...
	<div class="mod-search cf">
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix">
                <li>
                    <input type="text" id="type_name" name="type_name" class="ui-input ui-input-ph" placeholder="输入类型名称"   autocomplete="off" >
                </li>
                <li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/goods/top_cat_list.js" charset="utf-8"></script>
<?php
