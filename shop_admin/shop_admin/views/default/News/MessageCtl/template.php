    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li class="current"><a id="2" href="<?= YLB_Registry::get('url') ?>?ctl=News_Message&met=template&type=2"><span>商家消息模板</span></a></li>
                <li><a id="1" href="<?= YLB_Registry::get('url') ?>?ctl=News_Message&met=template&type=1"><span>用户消息模板</span></a></li>
                <li><a  href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=getMsgTpl&config_type%5B%5D=msg_tpl"><span>系统消息模板</span></a></li> -->
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/news/message/template_list.js"></script>
<?php
