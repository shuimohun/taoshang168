    ...
    <div class="fixed-bar">
        <div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span>金蛋明细</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=points&config_type%5B%5D=points"><span>规则设置</span></a></li>
				<li><a href="<?= YLB_Registry::get('url') ?>?ctl=User_Points&met=addPoints"><span>金蛋增减</span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
