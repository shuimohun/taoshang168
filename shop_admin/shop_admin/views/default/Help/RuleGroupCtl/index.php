...
<div class="wrapper page">
  <div class="fixed-bar">
    ...
    <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Help_Base&met=index"><span>文章管理</span></a></li> -->
		</ul>
    </div>
  </div>
...
<script type="text/javascript" src="<?= $this->view->js ?>/controllers/help/rule_group_list.js" charset="utf-8"></script>
<?php
