...
?>
    ...
    <form id="help_form" method="post">
        <div class="ncap-form-default">
            ...
            <!--	  <dl class="row">-->
            <!--        <dt class="tit">-->
            <!--          <label for="rule_help">规则/规则:</label>-->
            <!--        </dt>-->
            <!--        <dd class="opt">-->
            <!--          <div class="onoff">-->
            <!--            <label for="rule_type1" class="cb-enable  ">规则</label>-->
            <!--            <label for="rule_type2" class="cb-disable  selected">规则</label>-->
            <!--            <input id="rule_type1"  name ="help_or_rule"  value="规则" type="radio">-->
    ...
    <script type="text/javascript" src="<?=$this->view->js?>/controllers/help/rule_base_manage.js" charset="utf-8"></script>
    <script>
        //分步获取商品分类
        if(oper == 'add'){
        ...
        function getCatList(p_id, $select, change) {
            ...
            $.get(SITE_URL + '?ctl=Help_RuleBase&met=getGroupByClass&typ=json', {p_id: p_id}, function(data){
                if (data.status == 200) {
