...
?>
        ...
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    ?>
                    <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=information&config_type%5B%5D=information"><span>资讯发帖设置</span></a></li>
                </ul>
            </div>
        </div>
        <!-- 操作说明 -->
    ...
    <script type="text/javascript" src="<?= $this->view->js ?>/controllers/information/audit_list.js" charset="utf-8"></script>
<?php
