    ...
    <div class="mod-toolbar-top cf">
        ...
        <div class="fr">
             <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">
                 新增
                 <i class="iconfont icon-btn03"></i>
             </a>
             <a class="ui-btn" id="btn-refresh">
                 刷新
...
<script type="text/javascript" src="<?= $this->view->js ?>/controllers/information/base_list.js" charset="utf-8"></script>
<?php
