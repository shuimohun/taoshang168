...
<div class="wrapper page">
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        ...
                        <li><span id="payment_channel"></span></li>
						<li>
            ...
            <div class="fr">
             ...
             <div style="float:left;clear:left;display:inline-block;padding: 0 6px 0 0;line-height: 30px;height: 30px;font-size: 12px;border-radius: 2px;vertical-align: middle;">
                <b>订单选中金额：</b>￥ <span class="count_amount">0.00</span>
            </div>
            <div style="float:left; margin-left:10px;display:inline-block;padding: 0 6px 0 0;line-height: 30px;height: 30px;font-size: 12px;border-radius: 2px;vertical-align: middle;">
                <b>订单数：</b> <span class="count_amount_row">0</span>
            </div>
            <div style="float:left; margin-left:10px;display:inline-block;padding: 0 6px 0 0;line-height: 30px;height: 30px;font-size: 12px;border-radius: 2px;vertical-align: middle;">
                <b>订单金额：</b>￥ <span class="count_amount_price">0.00</span>
            </div>
        </div>
        <div class="grid-wrap">
            <table id="grid"></table>
    ...
    <script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/trade/order/order_list.js"></script>
</div>
<?php
