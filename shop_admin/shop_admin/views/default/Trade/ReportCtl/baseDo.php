    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Trade_Report&met=baseDone"><span>已处理</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Trade_Report&met=type"><span>类型设置</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Trade_Report&met=subject"><span>主题设置</span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
