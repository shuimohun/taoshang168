        ...
        <div class="ncap-form-default">
                    ...
                    <ul class="nofloat">
                        <li>
							 <select name="report_type_id">
								 ...
								 <option value="<?=$v['report_type_id']?>"><?=$v['report_type_name']?></option>
								 <?php } ?>
							 </select>
                        </li>
                    </ul>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <ul class="nofloat">
						<li>
							<input id="report_subject_name" name="report_subject_name" class="ui-input w200" type="text" />
						</li>
                    </ul>
                </dd>
            </dl>
	...
	function initPopBtns()
			...
			$_form.validator({
				...
				valid: function (form)
				{
					...
					me.holdSubmit();
					n = "添加";
					Public.ajaxPost(SITE_URL+"?ctl=Trade_Report&typ=json&met=addSubjectBase", $_form.serialize(), function (e)
					{
						if (200 == e.status)
						{
