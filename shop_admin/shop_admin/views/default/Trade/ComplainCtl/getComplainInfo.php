            ...
            <div class="tabs-panels">
                <div class="misc-info">
                    <dl>
                        <dt>店铺名称：</dt>
                        <dd>
                            <a target="_blank" href="<?= YLB_Registry::get('shop_api_url') ?>?ctl=Shop&met=index&typ=e&id=<?=($data['order_detail']['shop_id'])?>"> <?=($data['order_detail']['shop_name'])?> </a>
                        </dd>
                        ...
                        <dt>订单号：</dt>
                        <dd>
                            <a href="<?= YLB_Registry::get('url') ?>?ctl=Trade_Order&met=getOrderInfo&order_id=<?=($data['order']['order_id'])?>"> <?=($data['order']['order_id'])?></a>
                        </dd>
                ...
                <div class="goods-info">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a target="_blank" href="<?= YLB_Registry::get('shop_api_url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($data['complain_goods']['goods_id'])?>" style="text-decoration:none;">
                                ...
                                <td>
                                    <p>
                                        <a target="_blank" href="<?= YLB_Registry::get('shop_api_url') ?>?ctl=Goods_Goods&met=goods&gid=<?=($data['complain_goods']['goods_id'])?>"><?=($data['complain_goods']['goods_name'])?></a>
                                    </p>
                                    <p></p>
                                </td>
