...
?>
    ...
    <script type="text/javascript" src="<?= $this->view->js_com ?>/plugins/validator/local/zh_CN.js"
            charset="utf-8"></script>
<style>
    .ncap-form-default dt.bbc_color{color:#db2c2c;}
</style>
    </head>
    <body>
    <?php if($data['return_type'] == 2){$return_type = '退货';} else {$return_type = '退款';}?>
    <div class="wrapper page">
        <div class="fixed-bar">
            <div class="item-title">
                <div class="subject">
                    <h3><?php echo $return_type.'管理';?>
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit bbc_color">买家<?php echo $return_type;?>申请</dt>
            </dl>
            <dl class="row">
            ...
            <dl class="row">
                <dt class="tit"><?php echo $return_type;?>时间</dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
            ...
            <dl class="row">
                <dt class="tit bbc_color">订单支付信息</dt>
            </dl>
            <dl class="row">
                <dt class="tit">支付单号</dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
            ...
            <?php if($data['return_shop_state'] == 3 || $data['return_shop_state'] == 5){?>
                <dl class="row">
                    <dt class="tit bbc_color">商家处理</dt>
                </dl>
                <dl class="row">
            ...
            <?php if($data['return_platform_state'] == 1){ ?>
                <dl class="row">
                    <dt class="tit bbc_color">平台处理</dt>
                </dl>
                <form method="post" id="handle_finish" action="">
                    ...
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <ul class="nofloat">
                                <li>
                                    <span><?= $data['return_platform_add_time'] ?></span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                    ...
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <ul class="nofloat">
                                <li>
                                    <a id="btn_handle_submit" class="ui-btn ui-btn-sp submit-btn" href="javascript:void(0)" >审核同意</a>
                                    <a id="btn_handle_submit1" class="ui-btn ui-btn-sp submit-btn" href="javascript:void(0)" >审核不同意</a>
                                </li>
                            </ul>
                        </dd>
                    </dl>
            ...
            <?php if($data['return_platform_state'] == 2 || $data['return_platform_state'] == 3){?>
                <dl class="row">
                    <dt class="tit bbc_color">平台处理</dt>
                </dl>
                <dl class="row">
                    ...
                    <dd class="opt">
                        <ul class="nofloat">
                            <li>
                                <?php if($data['return_platform_state'] == 2){?>
                                    <?=('审核通过')?>
                                <?php }elseif($data['return_platform_state'] == 3){?>
                                    <?=('审核不通过')?>
                                <?php }?>
                            </li>
                        </ul>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <ul class="nofloat">
                            <li>
                                <span><?= $data['return_platform_time'] ?></span>
                            </li>
                        </ul>
                    </dd>
                </dl>
            ...
            <?php if($data['return_recheck_state']){?>
                <?php if($data['return_recheck_state'] == 1){ ?>
                    <dl class="row">
                        <dt class="tit bbc_color">平台处理</dt>
                    </dl>
                    <form method="post" id="handle_finish" action="">
                ...
                <?php }else { ?>
                    ...
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <ul class="nofloat">
                                <li>
                                    <span><?= $data['return_recheck_time'] ?></span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <ul class="nofloat">
                                <li>
                                    <span><?= $data['return_recheck_message'] ?></span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
