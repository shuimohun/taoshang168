        ...
        <div class="ncap-form-default">
			<dl class="row">
                ...
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
							 <input id="order_return_reason_content" name="order_return_reason_content" class="ui-input w200" type="text" />
                        </li>
                    </ul>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <ul class="nofloat">
						<li>
							<input id="order_return_reason_sort" name="order_return_reason_sort" class="ui-input w200" type="text" value="255"/>
						</li>
                    </ul>
	...
	function initPopBtns()
			...
			$_form.validator({
				...
				valid: function (form)
				{
					...
					me.holdSubmit();
					n = "添加";
					Public.ajaxPost(SITE_URL+"?ctl=Trade_Return&typ=json&met=addReasonBase", $_form.serialize(), function (e)
					{
						if (200 == e.status)
						{
