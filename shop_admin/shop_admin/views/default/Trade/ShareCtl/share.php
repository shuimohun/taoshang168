...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" href="javascript:void(0)"><span>分享管理</span></a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="left">
            <div id="assisting-category-select" class="ui-tab-select">
                <ul class="ul-inline">
                    ...
                    <li>
                        <input type="text" id="share_num" class="ui-input ui-input-ph con" placeholder="请输入分享编号...">
                    </li>
                    <li>
    ...
    <script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/trade/share/share_list.js"></script>
</div>
<?php
