...
<div class="wrapper page" >
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"  href="<?= YLB_Registry::get('url') ?>?ctl=Self_Adpage&met=adpage"><span>自营店铺首页模板</span></a></li>
    ...
    <div class="grid-wrap">
       ...
       <script type="text/javascript" src="<?=$this->view->js?>/controllers/self/adv_adpage_list.js" charset="utf-8"></script>
<?php
