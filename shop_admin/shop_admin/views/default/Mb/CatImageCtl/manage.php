...
<form method="post" id="shop_api-setting-form" name="settingForm" class="nice-validator n-yellow" novalidate="novalidate">
    <div class="ncap-form-default">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <img id="textfield1" name="textfield1" alt="选择图片" src="http://127.0.0.1/YLB_shop_admin/shop_admin/static/default/images/default_user_portrait.gif" width="90px" height="90px">
