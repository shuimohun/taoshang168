...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            ?>
                <!-- <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Subsite_Config&met=config"><span>分站设置设置</span></a></li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/subsite/subsite_list.js" charset="utf-8"></script>
<?php
