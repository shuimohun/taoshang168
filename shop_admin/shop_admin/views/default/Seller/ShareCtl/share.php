    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a  class="current"><span>分享立赚</span></a></li>
                <li><a  href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Share&met=share_price"><span>分享立省</span></a></li>
            </ul>
        </div>
    ...
    var THISPAGE = {
        ...
        loadGrid: function () {
            ...
            var colModel = [
                ...
                {label: '该地区店铺数量', name: 'value', width: 200, sortable: false, align: 'center'},
            ];
            ...
            $("#grid").jqGrid({
                url: SHOP_URL + '?ctl=Api_Seller_Share&met=share_demo&typ=json',
...
//                url: SITE_URL + '?ctl=Seller_Shop&met=area_map&typ=json&start_time='+start_time+'&end_time='+end_time+'&shop_class='+shop_class,
                url: SHOP_URL + '?ctl=Api_Seller_Share&met=share&typ=json&start_time='+start_time+'&end_time='+end_time,
                data: '',
                success: function (e) {
                    data = e.data;
