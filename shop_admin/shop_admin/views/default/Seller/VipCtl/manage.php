  ...
  <div class="fixed-bar">
    <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Gr&met=index"><span>统计概述</span></a></li>
                <li><a class="current" ><span>商品价格区间</span></a></li>
...
<!--   <div class="explanation" id="explanation">
  ...
  <form method="post" action="index.php" name="pricerangeform" id="pricerangeform">
    ...
    <div class="ncap-form-default">
        ...
        <dd class="opt" id="pricerang_table">
          <ul class="ncap-ajax-add">
            ...
            <li id="row_<?php echo $k; ?>">
              ...
              <label><a href="JavaScript:void(0);" onclick="delrow(<?php echo $k;?>);" class="ncap-btn ncap-btn-red"><?php echo $lang['nc_del']; ?>11</a></label>
            </li>
            <?php } ?>
            <?php } ?>
      ...
      <div class="bot"><a id="ncsubmit" class="ncap-btn-big ncap-btn-green" href="JavaScript:void(0);">确认提交</a></div>
    </div>
  </form>
</div>
