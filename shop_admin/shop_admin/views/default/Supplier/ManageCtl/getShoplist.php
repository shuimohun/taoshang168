...
<div style="   overflow: hidden;padding: 10px 3% 0;text-align: left;" >
	...
	<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
		<thead>
			<tr><th colspan="20">公司及联系人信息</th></tr>
		</thead>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
		<thead>
			<tr><th colspan="20">组织机构代码证</th></tr>
		</thead>
		<tbody>
			<tr>
				<th>组织机构代码：</th>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
		<thead>
			<tr><th colspan="20">一般纳税人证明：</th></tr>
		</thead>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="20"><img src="<?=$v?>" alt="" /></td>
			</tr>
				<?php }} ?>
		</tbody>
	</table>
	...
	<form id="form_store_verify" action="index.php?act=store&op=store_joinin_verify" method="post">
		...
		<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
			...
			<tbody>
				...
				<tr>
					<th>应付总金额：</th>
					<td>    <?=$val['shop_grade_fee']*$value['joinin_year']+$vals['shop_class_deposit'] ?> 元</td>
				</tr>
			  <?php }}} ?>
				<tr>
					<th>经营类目：</th>
					<td colspan="2">
						<table border="0" cellpadding="0" cellspacing="0" id="table_category" class="type">
							<thead>
								<tr>
									<th style="width:160px !important;">分类1</th>
									<th width="100">分类2</th>
									<th width="100">分类3</th>
									<th width="100">分类4</th>
									<th width="100">比例</th>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
		...
		<tr>
			...
			<td>
				<div class="onoff">
					<?php if($value['shop_status'] == 4){ ?>
						<label for="verify_enabled" class="cb-enable" title="是">是</label>
						<label for="verify_disabled" class="cb-disable selected" title="否">否</label>
						<input id="verify_enabled" name="shop_verify" value="2" type="radio">
						<input id="verify_disabled" name="shop_verify" checked="checked" value="4" type="radio">
					<?php }else{ ?>
						...
						<input id="verify_disabled" name="shop_verify" value="4" type="radio">
					<?php } ?>
				</div>
			</td>
		</tr>
