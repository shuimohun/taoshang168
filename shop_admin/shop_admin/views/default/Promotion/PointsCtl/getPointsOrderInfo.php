                ...
                <div class="goods-info">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;"><a href="<?=YLB_Registry::get('shop_api_url')?>?ctl=Points&met=detail&id=<?=$value['points_goodsid']?>" target="_blank"><?=$value['points_goodsname']?></a></td>
                    ...
                    <div class="total-amount">
                        <h3>兑换金蛋：<strong class="red_common"><?=@($data['points_allpoints'])?></strong></h3>
                    </div>
                </div>
                <?php } ?>
            </div>
