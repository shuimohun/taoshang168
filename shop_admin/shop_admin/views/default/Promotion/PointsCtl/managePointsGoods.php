...
<div class="manage-wrap">
    <div class="ncap-form-default">
        <form id="points_goods_form" action="" method="post">
            ...
            <dl class="row row-item">
                <dt class="tit"><em>*</em><label>礼品类型</label>：</dt>
                <dd class="opt">
                    <select name="points_goods_type" id="type">
                        <?php if($data['points_type']) {
                            foreach($data['points_type'] as $key=>$value) {
                        ?>
                        <option value="<?=$value['shop_class_id']?>" <?=@($data['points_goods_type']==$value['shop_class_id']?'selected':'')?>><?=$value['shop_class_name'] ?></option>
                        <?php } } ?>
                    </select>
                </dd>
            </dl>
            ...
            <dl class="row row-item">
                <dt class="tit"><em>*</em><label>兑换金蛋</label>：</dt>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic">当会员兑换金蛋商品时，需要达到该级别或者以上级别后才能参与兑换</p>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea id="container"  style="width:850px;height:300px;" name="points_goods_body" type="text/plain" ><?=@$data['points_goods_body']?></textarea>
                    <!-- 配置文件 -->
