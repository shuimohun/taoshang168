...
<div class="ncap-form-default">
	<form id="manage-form" action="#">
        ...
        <dl class="row row-item">
		    <dt class="tit" style="width:20%;">
                <em>*</em><label class="voucher_defaultpoints" for="voucher_defaultpoints">兑换金蛋数</label>
            </dt>
            <dd class="opt" style="width:75%;">
                <input type="text" value="" class="ui-input" name="voucher_defaultpoints" id="voucher_defaultpoints">
                <span class="err"></span>
                <p class="notic">当兑换代金券时，消耗的金蛋数</p>
            </dd>
        </dl>
	</form>
</div>
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/voucher/price_manage.js"></script>
<?php
