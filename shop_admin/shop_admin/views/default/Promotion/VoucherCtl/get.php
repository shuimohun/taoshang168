    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_Voucher&met=quota"><span>套餐列表</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_Voucher&met=price"><span>面额设置</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=voucher&config_type%5B%5D=voucher"><span>设置</span></a></li> -->
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/voucher/vouchertemp_list.js"></script>
<?php
