    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_ActGift&met=actGiftQuota"><span>套餐列表</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=mansong&config_type%5B%5D=mansong"><span>设置</span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/mansong/mansong_list.js"></script>
<?php
