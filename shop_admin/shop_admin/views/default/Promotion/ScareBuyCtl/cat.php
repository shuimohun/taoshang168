...
<div class="wrapper page">
    ...
    <div class="wrapper">
        <div class="mod-search cf">
            ...
            <div class="fr">
            <a  class="ui-btn ui-btn-sp" id="btn-add">新增<i class="iconfont icon-btn03"></i></a>
            </div>
        </div>
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/scarebuy/cat_list.js"></script>
<?php
