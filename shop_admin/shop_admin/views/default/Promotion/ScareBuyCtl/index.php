        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <li>
                         <input type="text" id="scarebuy_name" class="ui-input ui-input-ph matchCon" name="scarebuy_name" placeholder="惠抢购名称...">
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/scarebuy/scare_buy_list.js"></script>
<?php
