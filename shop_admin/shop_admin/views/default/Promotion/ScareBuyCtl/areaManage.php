...
<div id="manage-wrap" class="manage-wrap">
	<form id="manage-form" action="#">
		<ul class="mod-form-rows">
			<li class="row-item">
				<div class="label-wrap"><label for="scarebuy_area_name">地区名称:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="scarebuy_area_name" id="scarebuy_area_name"></div>
			</li>
			<li class="row-item">
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/promotion/vtscarebuy/area_manage.js" charset="utf-8"></script>
<?php
