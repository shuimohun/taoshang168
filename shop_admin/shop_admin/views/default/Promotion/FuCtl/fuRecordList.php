    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"><span>送福免单记录</span></a></li>
        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <!--<li>
                         <input type="text" id="fu_name" class="ui-input ui-input-ph matchCon" name="discount_name" placeholder="活动名称...">
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/fu/fu_record_list.js"></script>
<?php
