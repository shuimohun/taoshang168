    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_Discount&met=discountQuota"><span>套餐列表</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=discount&config_type%5B%5D=discount"><span>设置</span></a></li> -->
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/discount/discount_list.js"></script>
<?php
