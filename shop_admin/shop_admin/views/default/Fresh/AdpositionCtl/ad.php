...
<form id="form" method="post">
    <div class="form-table-style" style="clear:both">
       <?php
        ...
        <a  href="<?=YLB_Registry::get('base_url')?>?ctl=Fresh_Adposition&met=ad&item_id=<?php echo $vals['item_id'] ?>&page_id=<?php echo $data['page_id'] ?>&layout_id=<?php echo $data['layout_id'] ?>&widget_name=<?php echo $data['widget_name'] ?>&width=<?php echo $data['width'] ?>&height=<?php echo $data['height'] ?>&met=<?php echo $data['met'] ?>"><img style="width:140px;height:140px;margin: 10px;" src="<?php echo $vals['item_img_url'] ?>">
        </a>
...
<script>
    ...
    $(".item_id").click(function(){
        ...
        Public.ajaxPost(SITE_URL +"?ctl=Fresh_Adposition&typ=json&met=delitem" ,item, function (e)
         {
    ...
    $('#form').validate({
        ...
        submitHandler:function(form){
            ...
            Public.ajaxPost(SITE_URL +"?ctl=Fresh_Adposition&typ=json&met="+act , params, function (e)
            {
