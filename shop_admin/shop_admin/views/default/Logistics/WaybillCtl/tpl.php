...
<div class="wrapper page">
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <div class="mod-toolbar-top cf">
            ...
            <div class="fr">
				<a class="ui-btn ui-btn-sp mrb" id="btn-add" style="margin-right:10px;">新增<i class="iconfont icon-btn03"></i></a><a class="ui-btn ui-btn-sp" id="btn-refresh">刷新<i class="iconfont icon-btn01"></i></a>
...
<script src="<?= YLB_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/logistics/tpl/tpl_list.js"></script>
<?php
