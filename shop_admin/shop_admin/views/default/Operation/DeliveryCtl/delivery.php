	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
				<!-- <li><a <?php if($data['tab']=="manage"){ echo "class='current'";}else{?> href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Delivery&met=delivery" <?php } ?>><span>管理</span></a></li>
				<li><a <?php if($data['tab']=="check"){ echo "class='current'";}else{?> href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Delivery&met=delivery&dtyp=check" <?php } ?>><span>等待审核</span></a></li> -->
			</ul>
		</div>
	</div>
	<!-- 操作说明 -->
