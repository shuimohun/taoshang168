    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="index.php?ctl=Operation_Advertisement&met=check" class="current">待审核</a></li>
            </ul>
        </div>
    </div>
...
<!--    </div>-->
    ...
    <div class="wrapper">
        <div class="mod-search cf">
            ...
            <div class="fr"><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add">新增<i class="iconfont icon-btn03"></i></a><!--<a href="#" class="ui-btn mrb" id="btn-print">打印</a>--><a href="javascript:void(0)" class="ui-btn mrb" id="export">导出<i class="iconfont icon-btn04"></i></a><!--<a href="#" class="ui-btn" id="btn-batchDel">删除</a>--><a class="ui-btn" id="audit">审核<i class="iconfont icon-btn05"></i></a></div>
        </div>
        <div class="grid-wrap">
            <table id="grid">
            </table>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/adv/Advs.js" charset="utf-8"></script>
<?php
