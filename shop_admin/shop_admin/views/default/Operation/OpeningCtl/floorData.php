...
?>
        ...
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Opening&met=floorData"><span>楼层数据</span></a></li>
    ...
    <script type="text/javascript" src="<?=$this->view->js?>/controllers/operation/floor_data.js" charset="utf-8"></script>
<?php
