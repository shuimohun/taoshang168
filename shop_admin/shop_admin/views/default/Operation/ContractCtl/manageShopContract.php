                    ...
                    <ul class="nofloat">
                        <li>
						    <div class="onoff" id="contract_type_state">
								<label title="允许使用" class="cb-enable <?=($data['contract_state'] == 1 ? 'selected' : '')?> " for="contract_state_enable">允许使用</label>
								<label title="永久禁止使用" class="cb-disable <?=($data['contract_state'] == 1 ? '' : 'selected')?>" for="contract_state_disabled">永久禁止使用</label>
								<input type="radio" value="1" name="contract_state" id="contract_state_enable" <?=($data['contract_state'] == 1 ? 'checked' : '')?> />
								<input type="radio" value="2" name="contract_state" id="contract_state_disabled" <?=($data['contract_state'] == 1 ? '' : 'checked')?> />
						    </div>
                        </li>
                    </ul>
                </dd>
