	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
				<!-- <li><a <?php if($data['tab']=="join"){ echo "class='current'";}else{?> href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Contract&met=log&log=join" <?php } ?>><span>服务加入申请</span></a></li>
				<li><a <?php if($data['tab']=="quit"){ echo "class='current'";}else{?> href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Contract&met=log&log=quit" <?php } ?>><span>服务退出申请</span></a></li>
				<li><a href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Contract&met=service"><span>店铺保障服务</span></a></li>
				<li><a href="<?= YLB_Registry::get('url') ?>/?ctl=Operation_Contract&met=type"><span>保障服务管理</span></a></li> -->
			</ul>
		</div>
	</div>
	<!-- 操作说明 -->
