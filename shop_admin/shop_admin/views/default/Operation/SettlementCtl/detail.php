                        ...
                        <li><a <?php if ($data['tab'] == "order")
                            {
                                ...
                                href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Settlement&met=detail&id=<?= $data['id'] ?>&tab=order"><span>订单列表</span></a>
                        </li>
                        <li><a <?php if ($data['tab'] == "return")
                            {
                                echo "class='current'";
                            } ?>
                                href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Settlement&met=detail&id=<?= $data['id'] ?>&tab=return"><span>退单列表</span></a>
                        </li>
                        <li><a <?php if ($data['tab'] == "shop")
                            {
                                echo "class='current'";
                            } ?>
                                href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Settlement&met=detail&id=<?= $data['id'] ?>&tab=shop"><span>店铺费用</span></a>
                        </li>
                    <?php }
                        ...
                        <li><a <?php if ($data['tab'] == "used")
                            {
                                ...
                                href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Settlement&met=detail&id=<?= $data['id'] ?>&tab=used"><span>已使用</span></a>
                        </li>
                        <li><a <?php if ($data['tab'] == "unused")
                            {
                                echo "class='current'";
                            } ?>
                                href="<?= YLB_Registry::get('url') ?>?ctl=Operation_Settlement&met=detail&id=<?= $data['id'] ?>&tab=unused"><span>已过期</span></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
