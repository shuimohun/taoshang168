            ...
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    <?php if (isset($config['index_slider']) && $config['index_slider']):?>
                        <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_slider&config_type%5B%5D=index_slider"><span>首页幻灯片</span></a></li>
                    <?php endif;?>
                    <?php if (isset($config['index_slider_img']) && $config['index_slider_img']):?>
                        <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_liandong&config_type%5B%5D=index_liandong"><span>首页联动小图</span></a></li>
                    <?php endif;?>
                </ul>
            </div>
        </div>
