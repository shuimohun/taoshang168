    ...
    <form method="post" id="paycenter-shop_api-setting-form" name="paycenterSettingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_name" name="paycenter_api[paycenter_api_name]" value="<?=YLB_Registry::get('paycenter_api_name')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_url" name="paycenter_api[paycenter_api_url]" value="<?=YLB_Registry::get('paycenter_api_url')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_admin_api_url" name="paycenter_api[paycenter_admin_api_url]" value="<?=YLB_Registry::get('paycenter_admin_api_url')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_key" name="paycenter_api[paycenter_api_key]" value="<?=YLB_Registry::get('paycenter_api_key')?>" class="ui-input w400" type="text"/>
