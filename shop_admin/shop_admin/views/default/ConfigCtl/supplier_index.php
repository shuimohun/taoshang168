    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=supplier_index&config_type%5B%5D=supplier_index"><span>供应商首页幻灯片</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Supplier_Adpage&met=adpage"><span>供应商首页模板</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=supplier_index_img&config_type%5B%5D=supplier_index_img"><span>供应商首页小图</span></a></li>
            </ul>
        </div>
    </div>
