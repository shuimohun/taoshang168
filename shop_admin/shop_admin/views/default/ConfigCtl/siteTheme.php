                ...
                <div class="fixed-bar">
                    <div class="item-title">
                        ...
                        <ul class="tab-base nc-row">
                            ...
                            ?>
                            <!-- <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=onlineTheme&config_type%5B%5D=site"><span>线上模板</span></a></li> -->
                                        ...
                                        <dl class="current-style">
                                            ...
                                            foreach ($data['theme_row'] as $id=>$theme_row)
                                            {
                                                ...
                                                ?>
                                                    ...
                                                    <p class="links"><a href="<?= YLB_Registry::get('url') ?>?ctl=Floor_Adpage&met=adpage" onclick="parent.tab.addTabItem({text:'首页模板', url: '<?= YLB_Registry::get('url') ?>?ctl=Floor_Adpage&met=adpage'}); return false;"><span>首页模板设置</span></a></p>
                                                <?php endif;?>
                                                    <?php if (isset($config['index_slider']) && $config['index_slider']):?>
                                                    <p class="links"><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_slider&config_type%5B%5D=index_slider" onclick="parent.tab.addTabItem({text:'首页幻灯片', url: '<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_slider&config_type%5B%5D=index_slider'}); return false;"><span>首页幻灯片设置</span></a></p>
                                                <?php endif;?>
                                                    <?php if (isset($config['index_slider_img']) && $config['index_slider_img']):?>
                                                    <p class="links"><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_liandong&config_type%5B%5D=index_liandong" onclick="parent.tab.addTabItem({text:'首页联动小图', url: '<?= YLB_Registry::get('url') ?>?ctl=Config&met=index_liandong&config_type%5B%5D=index_liandong'}); return false;"><span>首页联动小图设置</span></a></p>
                                                <?php endif;?>
