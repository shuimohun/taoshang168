    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
              ...
              ?>
                <!-- <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=logistics&config_type%5B%5D=logistics&typ=e"><span>物流查询选用设置</span></a></li>
                <li><a class="current"><span>快递100</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=kuaidiniao&config_type%5B%5D=kuaidiniao"><span>快递鸟</span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">尚无Customer Id,<a href="https://www.kuaidi100.com/openapi/applypoll.shtml" target="_blank">申请</a></p>
                </dd>
            </dl>
