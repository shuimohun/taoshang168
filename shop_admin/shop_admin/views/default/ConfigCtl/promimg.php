    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_Points&met=goods" ><span>礼品列表</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Promotion_Points&met=order" ><span>兑换列表</span></a></li>
                <li><a class="current"><span>金蛋商城首页图片</span></a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">金蛋商城页显示，最佳显示尺寸为900*368像素</p>
