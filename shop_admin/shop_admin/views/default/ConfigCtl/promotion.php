		...
		<div class="ncap-form-default">
		  <!--<dl class="row">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="scarebuy_allow_1" class="cb-enable  <?=($data['scarebuy_allow']['config_value']=='1' ? 'selected' : '')?>" title="开启">开启</label>
                        <label for="scarebuy_allow_0" class="cb-disable <?=($data['scarebuy_allow']['config_value']=='0' ? 'selected' : '')?>" title="关闭">关闭</label>
                        <input id="scarebuy_allow_1" name="promotion[scarebuy_allow]" <?=($data['scarebuy_allow']['config_value']=='1' ? 'checked' : '')?> value="1" type="radio">
                        <input id="scarebuy_allow_0" name="promotion[scarebuy_allow]" <?=($data['scarebuy_allow']['config_value']=='0' ? 'checked' : '')?> value="0" type="radio">
                    </div>
                    <p class="notic">抢购功能启用后，商家通过活动发布抢购商品，进行促销</p>
                </dd>
            </dl>
		  ...
		  <dl class="row">
			...
			<dd class="opt">
			  ...
			  <p class="notic">金蛋商城启用后，网站将增加金蛋商城频道</p>
			</dd>
		  </dl>
		  <dl class="row">
			<dt class="tit">金蛋兑换</dt>
			<dd class="opt">
			  <div class="onoff">
			  ...
			  <p class="notic">金蛋兑换、金蛋功能以及金蛋商城启用后，平台发布礼品，会员的金蛋在达到要求时可以在金蛋商城中兑换礼品</p>
			</dd>
		  </dl>
		  <dl class="row">
			<dt class="tit">代金券</dt>
			<dd class="opt">
			  ...
			  <p class="notic">代金券功能、金蛋功能、金蛋商城启用后，商家可以申请代金券活动；会员金蛋达到要求时可以在金蛋商城兑换代金券；<br>拥有代金券的会员可在代金券所属店铺内购买商品时，选择使用而得到优惠</p>
			</dd>
		  </dl>
