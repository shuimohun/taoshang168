        ...
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <!-- <li><a class="current"><span>商城设置</span></a></li>
				 <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=search&config_type%5B%5D=search"><span>默认搜索</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Base_Search&met=search"><span>热门搜索</span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
