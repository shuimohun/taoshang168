...
<div class="wrapper page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                <li><a class="current" ><span>更新商城</span></a></li>
			</ul>
		</div>
	</div>
    ...
    <iframe  style="width: 100%;height: 500px;border: 0" src="<?= YLB_Registry::get('url') ?>?ctl=Config&met=upgradeShop&upgrade=<?=request_int('upgrade', 0)?>&force-upgrade=<?=request_int('force-upgrade', 0)?>">
    </iframe>
