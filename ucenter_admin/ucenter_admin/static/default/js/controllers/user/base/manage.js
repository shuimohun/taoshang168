...
function postData(t, e)
{
    ...
    {
        var i = $.trim($("#user_account").val()), a = $.trim($("#user_password").val()), r = $.trim($("#user_realname").val()), s = rights_group_id.getValue(), n = "add" == t ? "新增用户" : "修改用户";
        params = rowData.user_id ? {user_id: e, user_account: i, user_password: a, user_realname: r, rights_group_id: s} : {user_account: i, user_password: a, user_realname: r, rights_group_id: s};
