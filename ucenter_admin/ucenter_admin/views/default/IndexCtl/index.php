    ...
    <div class="col-hd cf">
        ...
        <div class="right cf">
           ...
           <!-- <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href">广告系统</i></a></li>
                ...
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href">IM系统</i></a></li> -->
        	...
        	<div class="nav-wrap hidden cf"><!--订单-->
                ...
                <div id="sub-nav">
                    ...
                    <ul class=" cf" id="base_app_version-base">
                        <li>
                            <i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=User_Db&met=lastest&typ=e" rel="pageTab" tabid="app-db" tabtxt="数据维护">数据维护</a>
                        </li>
                    </ul>
					<?php endif; ?>
				</div>
