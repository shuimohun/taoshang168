    ...
    <div id="manage-wrap" class="manage-wrap">
		...
		<input type="hidden" name="app_id" id = "app_id" value="">
			...
			<li class="row-item"  style="margin-top:10px;">
    			...
    			<!--
				<li class="row-item">
    				<div class="label-wrap"><label for="app_url">检查url地址</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="app_url_order" id="app_url_order"></div>
    			</li>
				<li class="row-item odd">
    				<div class="label-wrap"><label for="app_url">图片地址</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="app_logo" id="app_logo"></div>
    			</li>
				<li class="row-item">
    				<div class="label-wrap"><label for="app_url">域名列表</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="app_hosts" id="app_hosts"></div>
    			</li>
				<li class="row-item odd">
    				<div class="label-wrap"><label for="app_url">返回字段</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="return_fields" id="return_fields"></div>
    			</li>-->
    		</ul>
    </div>
