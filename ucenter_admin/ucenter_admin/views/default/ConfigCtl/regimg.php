    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=register&config_type%5B%5D=register"><span>注册设置</span></a></li>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt" style="width: 30%;">
                    ...
                    <p class="notic">注册页广告图片，最佳显示尺寸为300*543像素</p>
    ...
    $(function(){
        ...
        $('#register_logo_upload, #login_logo_upload').on('click', function () {
            ...
            if ( this.id == 'login_logo_upload' ) {
                ...
                imageWidth = 300, imageHeight = 543;
            }
