...
<div class="wrapper page">
	...
	<p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
		...
		<ul>
			<li>用户注册,找回密码,消息通知等需要用短信来发送通知,在使用短信功能之前,需要向北京淘尚壹陆捌网络科技有限公司购买短信。</li>
		</ul>
	</div>
	<div class="fixed-bar">
		<div class="item-title">
			<div class="subject">
				<h3>短信设置</h3>
				<h5>在北京淘尚壹陆捌网络科技有限公司购买的短信账号和密码</h5>
			</div>
					...
					<ul class="mod-form-rows" id="establish-form">
						...
						<li class="row-item">
							...
							<div class="ctn-wrap">
								...
								<p class="notic">在北京淘尚壹陆捌网络科技有限公司购买短信后,客服提供的用户名</p>
							</div>
						</li>
						<li class="row-item">
							<div class="label-wrap">
							...
							<div class="ctn-wrap">
								...
								<p class="notic">在北京淘尚壹陆捌网络科技有限公司购买短信后,客服提供的密码</p>
							</div>
						</li>
					</ul>
				</div>
