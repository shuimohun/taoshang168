    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=settings&typ=e&config_type%5B%5D=site"><span>站点Logo</span></a></li>
...
<script>
    ...
    $(function(){
        ...
        $('#site_logo_upload, #seller_logo_upload, #buyer_logo_upload').on('click', function () {
            ...
            $.dialog({
                title: '图片裁剪',
                content: "url: <?= YLB_Registry::get('url') ?>?ctl=Config&met=cropperImage&typ=e",
