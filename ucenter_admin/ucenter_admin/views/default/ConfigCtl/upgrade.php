...
<div class="wrapper page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=update"><span>更新管理中心</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=updateUcenter"><span>更新用户中心</span></a></li>
			</ul>
		</div>
	</div>
	...
	if ( $update )
	{
		...
		try{
			...
			$time = 2;
			$url = "<?= YLB_Registry::get('url') ?>?ctl=Config&met=update";
