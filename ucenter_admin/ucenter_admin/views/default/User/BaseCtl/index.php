    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current"  href="<?= YLB_Registry::get('url') ?>?ctl=User_Base&met=index"><span>管理员</span></a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Rights_Group&met=index"><span>权限组</span></a></li>
                <li><a  href="<?= YLB_Registry::get('url') ?>?ctl=Log_Action&met=index"><span>操作日志</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
