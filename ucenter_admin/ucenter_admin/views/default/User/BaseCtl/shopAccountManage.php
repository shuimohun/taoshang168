...
<div class="manage-wrapper">
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		<input type="hidden" value="<?=YLB_Registry::get('shop_app_id')?>" class="ui-input" name="request_app_id" id="request_app_id">
    		...
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			...
    			<li class="row-item">
    				...
    				<div class="ctn-wrap"><input type="text" value="http://www.taoshang168.com" class="ui-input" name="plantform_url" id="plantform_url"></div>
    			</li>
				<?php
    			...
    			<li class="row-item odd">
    				...
    				<div class="ctn-wrap"><input type="text" value="http://www.taoshang168.com/ucenter/index.php" class="ui-input" name="ucenter_url" id="ucenter_url"></div>
    			</li>

    			<li class="row-item">
    				<div class="label-wrap"><label for="paycenter_url">支付中心:</label></div>
    				<div class="ctn-wrap"><input type="text" value="http://t2.www.taoshang168.com/paycenter/index.php" class="ui-input" name="paycenter_url" id="paycenter_url"></div>
    			</li>
				<?php
				endif;
				?>
