...
<style>
body{background: #fff;}
.mod-form-rows .label-wrap{font-size:12px;text-align:right;}
...
<div class="manage-wrapper">
     <div id="manage-wrap" class="manage-wrap">
    	...
    	<input type="hidden" value="<?=YLB_Registry::get('erp_app_id')?>" class="ui-input" name="request_app_id" id="request_app_id">
    		<ul class="mod-form-rows base-form cf" id="base-form">
                ...
                <li class="row-item odd">
                    <div class="label-wrap">
                        <label for="plantform_url">BBC URL：</label>
                    </div>
                    <div class="ctn-wrap">
                        <input type="text" name="bbc_url" class="ui-input" id="bbc_url" value="http://www.taoshang168.com/shop/index.php" />
                    </div>
                </li>
