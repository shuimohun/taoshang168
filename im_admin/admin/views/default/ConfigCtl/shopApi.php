    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=shopApi&config_type%5B%5D=api"><span>Shop API设置</span></a></li>
            </ul>
        </div>
    </div>
    <?php
    ...
    <form method="post" id="shop_api-setting-form" name="settingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shop_admin_api_url" name="shop_api[shop_admin_api_url]" value="<?=YLB_Registry::get('shop_admin_api_url')?>" class="w400 ui-input " type="text"/>
