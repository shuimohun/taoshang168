...
*/
class Plugin_Xhprof implements YLB_Plugin_Interface
{
    ...
    function __construct()
    {
        ...
        */
        ...
        //第三个是插件所执行的方法
        YLB_Plugin_Manager::getInstance()->register('init', $this, 'startXhprof');
        YLB_Plugin_Manager::getInstance()->register('end', $this, 'endXhprof');
    }
   ...
   function endXhprof($data=null)
   {
       if ($this->xhprof_on)
       {
            ...
            fb(YLB_Registry::get('base_url') .'/erp/controllers/Plugin/Xhprof/xhprof_html/index.php?run=' . $run_id . '&source=' . $ctl . '_' . $met);
       }
   }
}
?>