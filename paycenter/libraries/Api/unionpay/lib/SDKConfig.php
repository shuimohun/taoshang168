...
// 签名证书路径 /data/www/www.taoshang168.com/paycenter/libraries
const SDK_SIGN_CERT_PATH = '/data/www/www.taoshang168.com/paycenter/libraries/Api/unionpay/lib/certs/acp_test_sign.pfx';
...
const SDK_VERIFY_CERT_DIR = '/data/www/www.taoshang168.com/paycenter/libraries/Api/unionpay/lib/certs';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/data/www/bbc_lt/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/data/www/bbc_lt/logs/';
