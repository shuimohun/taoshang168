 ...
 * @todo       
 */
class Service_Fee extends YLB_Model
{
    public $_cacheKeyPrefix  = 'c|service_fee|';
    public $_cacheName       = 'service';
    public $_tableName       = 'service_fee';
     ...
     * @access public
     */
    public function getFee($id=null, $sort_key_row=null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function addFee($field_row, $return_insert_id=false)
    {
     ...
     * @access public
     */
    public function editid($config_key=null, $field_row)
    {
     ...
     * @access public
     */
    public function editFeeSingleField($id, $field_name, $field_value_new, $field_value_old)
    {
