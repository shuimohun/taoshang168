...
class Payment_UnionPayModel implements Payment_Interface
{
	...
	public function __construct($payment_row = array(), $order_row = array())
	{
		...
		$this->payment['return_url'] = YLB_Registry::get('base_url') . "/paycenter/api/payment/unionpay/return_url.php"; //返回URL
		$this->payment['notify_url'] = YLB_Registry::get('base_url') . "/paycenter/api/payment/unionpay/return_url.php"; //通知URL
	}
