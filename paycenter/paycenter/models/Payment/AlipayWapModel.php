...
class Payment_AlipayWapModel implements Payment_Interface
{
	...
	public function pay($order_row)
	{
		...
		//**req_data详细信息**
		//卖家支付宝帐户
		$seller_email = $this->payment['alipay_account']; //必填

		//商户订单号
		$out_trade_no = $this->order['union_order_id']; //商户网站订单系统中唯一订单号，必填
		...
		$body = $this->order['trade_title']; //必填
	...
	public function getReturnData($Consume_TradeModel = null)
	{
		...
		$notify_row['payment_channel_id']   = Payment_ChannelModel::ALIPAY_WAP;
		return $notify_row;
	}
}
