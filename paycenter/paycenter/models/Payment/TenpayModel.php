...
class Payment_TenpayModel implements Payment_Interface
{
	...
	public function __construct($payment_row = array(), $order_row = array())
	{
		...
		//返回URL
		$this->payment['return_url'] = YLB_Registry::get('base_url') . "/paycenter/api/payment/tenpay/return_url.php";

		//通知URL
		$this->payment['notify_url'] = YLB_Registry::get('base_url') . "/paycenter/api/payment/tenpay/notify_url.php";
	}
