...
/* 		"TRADE_FINISHED" => '未付款', */
	 ...
	 * @access public
	 */
	public function notifyShop($order_id = null,$user_id = null,$payment_channel_id = 0,$deposit_trade_no = '')
	{
        $rs_row = array();
        ...
        if ($union_order['trade_payment_amount'] == $union_order['union_online_pay_amount'] + $union_order['union_money_pay_amount'] + $union_order['union_cards_pay_amount'])
        {
            ...
            if($deposit_trade_no)
			{
                $edit_row['trade_no']           = $deposit_trade_no;
            }
            ...
            $edit_uorder_row['payment_channel_id'] = $payment_channel_id;
            if($deposit_trade_no)
            {
                $edit_uorder_row['trade_no']           = $deposit_trade_no;
            }
            ...
            $order_edit_row['payment_channel_id'] = $payment_channel_id;
            $Consume_TradeModel = new Consume_TradeModel();
            ...
            if (is_ok($rs_row) && $Union_OrderModel->sql->commitDb())
            {
                ...
                $formvars['payment_channel_id'] = $payment_channel_id;
	...
	public function notifyDeposit($order_id = null,$user_id = null,$pay_channel = null)
	{
        ...
        if ($union_order['trade_payment_amount'] == $union_order['union_online_pay_amount'] + $union_order['union_money_pay_amount'] + $union_order['union_cards_pay_amount'])
		{
            ...
            $record_id_row = array_column($record_row,'consume_record_id');*/
            $record_id_row = $Consume_RecordModel->getKeyByWhere(array('order_id'=> $order_id));
