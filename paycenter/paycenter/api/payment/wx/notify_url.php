...
YLB_Log::log('$verify_result=' . $verify_result, YLB_Log::INFO, 'pay_wxnative_notify');
...
if ($verify_result)
{
	...
	if ($notify_row)
	{
        ...
        YLB_Log::log('Process-SUCCESS', YLB_Log::INFO, 'pay_wxnative_notify');
	}
	else
	{
		echo "FAIL";
		YLB_Log::log('Process-FAIL', YLB_Log::ERROR, 'pay_wxnative_notify_error');
		YLB_Log::log('Process-FAIL', YLB_Log::ERROR, 'pay_wxnative_notify');
	}
...
else
{
	//验证失败
	echo "FAIL";
	YLB_Log::log($error_msg, YLB_Log::ERROR, 'pay_wxnative_notify_error');
	YLB_Log::log($error_msg, YLB_Log::ERROR, 'pay_wxnative_notify');
