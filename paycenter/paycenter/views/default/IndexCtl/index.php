...
<body style="width:100%;height:100%;">
	<div class="index">
		<div class="index-head"><p>财付宝</p></div>
	</div>
	<div class="center-content">
		<div class="slogan"></div>
		<div class="mid">
			<div class="main-entry"><a href="<?/*=YLB_Registry::get('url')*/?>?ctl=Login&met=login" class="login"><i></i><span>用户登录</span></a><a href="<?/*=YLB_Registry::get('url')*/?>?ctl=Login&met=reg" class="regist"><i></i><span>立即注册</span></a></div>
		</div>
	</div>
	<div class="back">
		<div class="items">
