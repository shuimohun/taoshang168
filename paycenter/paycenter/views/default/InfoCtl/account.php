		...
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
					...
					<td class="account_ahref"><a href="<?=YLB_Registry::get('ucenter_api_url')?>?ctl=User&met=getUserInfo"><?=_('修改信息')?></a></td>
				</tr>
				<tr>
					<td><?=_('手机号码')?></td>
		...
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
					...
					<td class="account_ahref"><a href="<?= YLB_Registry::get('url') ?>?ctl=Info&met=passwd"><?=_('修改')?></a>|<a href="<?= YLB_Registry::get('url') ?>?ctl=Info&met=passwd"><?=_('找回支付密码')?></a></td>
				</tr>
				</tbody>
			</table>
		</div>
		<div class="account_mes">
			...
			<table class="account_table">
				...
				<tr>
					...
					<td class="account_ahref"><?php if($user_info['user_identity_statu'] == 0){?><a href="<?= YLB_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('去实名认证')?></a><?php }elseif($user_info['user_identity_statu'] == 1){?><?=_('待审核')?><a href="<?= YLB_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('重填实名认证')?></a><?php }elseif($user_info['user_identity_statu'] == 2){?><?=_('已实名认证成功')?><?php }else{?><?=_('认证失败')?><a href="<?= YLB_Registry::get('url') ?>?ctl=Info&met=certification"><?=_('重新去实名认证')?></a><?php }?></td>
				</tr>
				<tr>
					<td><?=_('证件类型')?></td>
