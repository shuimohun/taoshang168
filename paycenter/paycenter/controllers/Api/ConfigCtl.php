...
YLB_Registry::set(\'sms_config\', $sms_config);

return $sms_config;
?>';

				$file = INI_PATH . '/sms_' . YLB_Registry::get('server_id') . '.ini.php';
...
?>';
		...
		$file = INI_PATH . '/connect_' . YLB_Registry::get('server_id') . '.ini.php';
		$flag = file_put_contents($file, $str);
		//$data['bbbb'] = '42342';
		$this->data->addBody(-140, array());
	}
	public function edit1()
	{
		...
		if (is_file(INI_PATH . '/global_' . YLB_Registry::get('server_id') . '.ini.php'))
		{
			$file = INI_PATH . '/global_' . YLB_Registry::get('server_id') . '.ini.php';
		}
		else
