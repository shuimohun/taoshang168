...
class Api_KdNiao
{
	...
	public function __construct($e_business_id=null, $app_key=null, $req_url='http://api.kdniao.cc/Ebusiness/EbusinessOrderHandle.aspx')
	{
		$this->eBusinessId = $e_business_id;//必填参数
		$this->appKey      = $app_key;//必填参数
		$this->reqURL      = $req_url;
	}
	 ...
	 * XML方式 在线下单
	 *
	 * @param array $request_data 请求的数据(不推荐使用XML)
	 */
