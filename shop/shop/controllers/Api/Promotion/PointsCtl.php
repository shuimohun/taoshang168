...
class Api_Promotion_PointsCtl extends Api_Controller
{
	...
	public function addPointsGoods()
	{
		...
		$field_row['points_goods_points']  = request_int('points_goods_points');//兑换金蛋
        ...
        $field_row['points_goods_type']    = request_int('points_goods_type');//礼品类型
	...
	public function managePointsGoods()
	{
        ...
        $arr                   = $this->Shop_ClassModel->listClassWhere();
        $data['points_type']   = $arr['items'];
