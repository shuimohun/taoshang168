...
/**
 * @author Zhenzh 生鲜特产楼层模版
 */
class Api_Fresh_AdpageCtl extends YLB_AppController
{
	...
	{   
        $cond_row['sub_site_id'] = Adv_PageSettingsModel::FRSH; //生鲜特产单独模板
        $order_row['page_order'] = 'asc';
		$data = $this->AdvPageSettingsModel->listPageSettingsWhere($cond_row,$order_row);
	...
	public function addPagerow()
	{
        ...
        $data['sub_site_id'] =    Adv_PageSettingsModel::FRSH;    //生鲜特产单独模板
