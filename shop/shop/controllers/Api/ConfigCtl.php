...
//        file_put_contents('2.text',json_encode($data));
    ...
    public function setPluginState()
    {
        ...
        if ($config_key) {
            ...
            $rs = YLB_Utils_File::generatePhpFile($file, array('plugin_rows' => $plugin_rows));
        }
...
//$mail->AddAttachment("f:/test.png"); //可以添加附件
    ...
    public function initDb()
    {
        ...
        /*
        truncate table `YLB_adv_page_settings`;
        truncate table `YLB_adv_page_statistics_area`;
        truncate table `YLB_adv_page_statistics_day`;
        truncate table `YLB_adv_widget_base`;
        truncate table `YLB_adv_widget_cat`;
        truncate table `YLB_adv_widget_item`;
        truncate table `YLB_adv_widget_nav`;
        truncate table `YLB_adv_widget_statistics_area`;
        truncate table `YLB_adv_widget_statistics_day`;
        truncate table `YLB_advertisement`;
        truncate table `YLB_analysis_platform_area`;
        truncate table `YLB_analysis_platform_class`;
        truncate table `YLB_analysis_platform_general`;
        truncate table `YLB_analysis_platform_goods`;
        truncate table `YLB_analysis_platform_return`;
        truncate table `YLB_analysis_platform_total`;
        truncate table `YLB_analysis_platform_user`;
        truncate table `YLB_analysis_shop_area`;
        truncate table `YLB_analysis_shop_general`;
        truncate table `YLB_analysis_shop_goods`;
        truncate table `YLB_analysis_shop_user`;
        truncate table `YLB_announcement`;
        truncate table `YLB_article_base`;
        truncate table `YLB_article_group`;
        truncate table `YLB_article_reply`;
        truncate table `YLB_base_cron`;
        truncate table `YLB_base_filter_keyword`;
        truncate table `YLB_base_menu`;
        truncate table `YLB_card_base`;
        truncate table `YLB_cart`;
        truncate table `YLB_complain_base`;
        truncate table `YLB_complain_goods`;
        truncate table `YLB_complain_subject`;
        truncate table `YLB_complain_talk`;
        truncate table `YLB_consult_base`;
        truncate table `YLB_consult_reply`;
        truncate table `YLB_delivery_base`;
        truncate table `YLB_discount_base`;
        truncate table `YLB_discount_combo`;
        truncate table `YLB_discount_goods`;
        truncate table `YLB_feed_base`;
        truncate table `YLB_feed_group`;
        truncate table `ylb_goods_base`;
        truncate table `YLB_goods_brand`;
        truncate table `YLB_goods_cat`;
        truncate table `YLB_goods_cat_nav`;
        truncate table `YLB_goods_common`;
        truncate table `YLB_goods_common_detail`;
        truncate table `YLB_goods_evaluation`;
        truncate table `YLB_goods_format`;
        truncate table `YLB_goods_images`;
        truncate table `YLB_goods_property`;
        truncate table `YLB_goods_property_index`;
        truncate table `YLB_goods_property_value`;
        truncate table `YLB_goods_recommend`;
        truncate table `YLB_goods_service`;
        truncate table `YLB_goods_spec`;
        truncate table `YLB_goods_spec_value`;
        truncate table `YLB_goods_state`;
        truncate table `YLB_goods_type`;
        truncate table `YLB_goods_type_brand`;
        truncate table `YLB_goods_type_spec`;
        truncate table `YLB_grade_log`;
        truncate table `YLB_groupbuy_area`;
        truncate table `YLB_groupbuy_base`;
        truncate table `YLB_groupbuy_cat`;
        truncate table `YLB_groupbuy_combo`;
        truncate table `YLB_groupbuy_price_range`;
        truncate table `YLB_increase_base`;
        truncate table `YLB_increase_combo`;
        truncate table `YLB_increase_goods`;
        truncate table `YLB_increase_redemp_goods`;
        truncate table `YLB_increase_rule`;
        truncate table `YLB_invoice`;
        truncate table `YLB_log_action`;
        truncate table `YLB_mansong_base`;
        truncate table `YLB_mansong_combo`;
        truncate table `YLB_mansong_rule`;
        truncate table `YLB_mb_cat_image`;
        truncate table `YLB_mb_tpl_layout`;
        truncate table `YLB_member_agreement`;
        truncate table `YLB_member_consume_log`;
        truncate table `YLB_message`;
        truncate table `YLB_message_setting`;
        truncate table `YLB_number_seq`;
        truncate table `YLB_order_base`;
        truncate table `YLB_order_base1`;
        truncate table `YLB_order_delivery`;
        truncate table `YLB_order_goods`;
        truncate table `YLB_order_goods_snapshot`;
        truncate table `YLB_order_goods_virtual_code`;
        truncate table `YLB_order_log`;
        truncate table `YLB_order_payment`;
        truncate table `YLB_order_return`;
        truncate table `YLB_order_settlement`;
        truncate table `YLB_order_settlement_stat`;
        truncate table `YLB_payment_channel`;
        truncate table `YLB_platform_custom_service`;
        truncate table `YLB_platform_custom_service_type`;
        truncate table `YLB_platform_nav`;
        truncate table `YLB_platform_report`;
        truncate table `YLB_platform_report_subject`;
        truncate table `YLB_platform_report_subject_type`;
        truncate table `YLB_points_cart`;
        truncate table `YLB_points_goods`;
        truncate table `YLB_points_log`;
        truncate table `YLB_points_order`;
        truncate table `YLB_points_orderaddress`;
        truncate table `YLB_points_ordergoods`;
        truncate table `YLB_rec_position`;
        truncate table `YLB_report_base`;
        truncate table `YLB_report_subject`;
        truncate table `YLB_search_word`;
        truncate table `YLB_seller_base`;
        truncate table `YLB_seller_log`;
        truncate table `YLB_seller_rights_base`;
        truncate table `YLB_seller_rights_group`;
        truncate table `YLB_service`;
        truncate table `YLB_shared_bindings`;
        truncate table `YLB_shop_base`;
        truncate table `YLB_shop_class`;
        truncate table `YLB_shop_class_bind`;
        truncate table `YLB_shop_company`;
        truncate table `YLB_shop_contract`;
        truncate table `YLB_shop_contract_log`;
        truncate table `YLB_shop_cost`;
        truncate table `YLB_shop_custom_service`;
        truncate table `YLB_shop_decoration`;
        truncate table `YLB_shop_decoration_album`;
        truncate table `YLB_shop_decoration_block`;
        truncate table `YLB_shop_domain`;
        truncate table `YLB_shop_entity`;
        truncate table `YLB_shop_evaluation`;
        truncate table `YLB_shop_express`;
        truncate table `YLB_shop_extend`;
        truncate table `YLB_shop_goods_cat`;
        truncate table `YLB_shop_grade`;
        truncate table `YLB_shop_nav`;
        truncate table `YLB_shop_points_log`;
        truncate table `YLB_shop_renewal`;
        truncate table `YLB_shop_shipping_address`;
        truncate table `YLB_shop_supplier`;
        truncate table `YLB_sub_site`;
        truncate table `YLB_transport_item`;
        truncate table `YLB_transport_offpay_area`;
        truncate table `YLB_transport_type`;
        truncate table `YLB_upload_album`;
        truncate table `YLB_upload_base`;
        truncate table `YLB_user_address`;
        truncate table `YLB_user_base`;
        truncate table `YLB_user_buy`;
        truncate table `YLB_user_extend`;
        truncate table `YLB_user_favorites_brand`;
        truncate table `YLB_user_favorites_goods`;
        truncate table `YLB_user_favorites_shop`;
        truncate table `YLB_user_footprint`;
        truncate table `YLB_user_friend`;
        truncate table `YLB_user_info`;
        truncate table `YLB_user_message`;
        truncate table `YLB_user_privacy`;
        truncate table `YLB_user_resource`;
        truncate table `YLB_user_tag`;
        truncate table `YLB_user_tag_rec`;
        truncate table `YLB_user_type`;
        truncate table `YLB_voucher_base`;
        truncate table `YLB_voucher_combo`;
        truncate table `YLB_voucher_price`;
        truncate table `YLB_voucher_template`;
        truncate table `YLB_waybill_tpl`;
         */
    ...
    public function update()
    {
        ...
        $upgrader = new \YLB\Upgrader\Core($app_id, $client_version, LANG, $db_id, $db_prefix, $db_prefix_base);
