...
class WebPosApi_UserCtl extends WebPosApi_Controller
{
    ...
    public function editInfo()
    {
        ...
        if ($data)
        {
            ...
            $money_row = get_url_with_encrypt($key, sprintf('%sindex.php?ctl=Index&met=getUserResourceInfo&typ=json', YLB_Registry::get('paycenter_api_url')), $formvars);
    ...
    public function addUserInfo()
    {
        ...
        if (200 == $init_rs['status'])
        {
            ...
            $user_resource_row['user_pointssum'] = Web_ConfigModel::value("points_reg");//注册获取金蛋;(sum)
