...
class Chain_OrderCtl extends Chain_Controller
{
    ...
    public function index()
    {
        ...
        $cond_row = array();
        $cond_row['order_status'] = Order_StateModel::ORDER_SELF_PICKUP;
        ...
        $data = $this->orderBaseModel->getBaseList($cond_row, array('order_create_time'=>'desc'), $page, $rows);
    ...
    public function processOrder()
    {
        ...
        if ($pickup_code == $order_goodsChainCode['chain_code_id']) {
            ...
            $flag = $order_goodsChainCodeModel->editGoodsChainCode($order_id, $code_row);
