 ...
 * @todo
 */
class Plugin_Directseller implements YLB_Plugin_Interface
{
	...
	public function __construct()
	{
		...
		//第三个是插件所执行的方法
		YLB_Plugin_Manager::getInstance()->register('rec_goods', $this, 'recGoods');
		YLB_Plugin_Manager::getInstance()->register('regDone', $this, 'regDone');
	}

	public static function desc()
	{
		return '淘金系统，使用淘金时，请勿关闭！';
	}
