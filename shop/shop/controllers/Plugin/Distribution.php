 ...
 * @todo
 */
class Plugin_Distribution implements YLB_Plugin_Interface
{
	...
	public function __construct()
	{
		...
		//第三个是插件所执行的方法
		YLB_Plugin_Manager::getInstance()->register('init', $this, 'init');
		YLB_Plugin_Manager::getInstance()->register('end',  $this, 'end');
		YLB_Plugin_Manager::getInstance()->register('admin_menu',   $this, 'setAdminMenu');
		YLB_Plugin_Manager::getInstance()->register('admin_menu_p', $this, 'setAdminMenuP');
		YLB_Plugin_Manager::getInstance()->register('shop_menu_show', $this, 'setMenuShow');
		YLB_Plugin_Manager::getInstance()->register('reg_done', $this, 'regDone');
		YLB_Plugin_Manager::getInstance()->register('dist_product', $this, 'listDistProduct');

		YLB_Plugin_Manager::getInstance()->register('add_distribution_goods', $this, 'addDistributionProductInfo');
		YLB_Plugin_Manager::getInstance()->register('edit_distribution_goods', $this, 'editDistributionProductInfo');

		YLB_Plugin_Manager::getInstance()->register('confirm_received_product', $this, 'confirmReceivedProduct');
		YLB_Plugin_Manager::getInstance()->register('confirm_return_product', $this, 'confirmReturnProduct');

		YLB_Plugin_Manager::getInstance()->register('edit_shop_commission', $this, 'editShopCommission');
	...
	public function init()
	{
		...
		if (!YLB_Registry::isRegistered('distribution'))
		{
			...
			YLB_Registry::set('distribution', $distribution);
			...
			YLB_Registry::set('dist_user_row', $dist_user_row);
		}
		*/
	}
	...
	public function listDistProduct($user_id)
	{
		...
		$tpl->assign("dist_user_row", YLB_Registry::get('dist_user_row'));
