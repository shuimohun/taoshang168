 ...
 * @todo
 */
class Operation_AdvTypeName extends YLB_Model
{
    public $_cacheKeyPrefix  = 'c|advs_type|';
    public $_cacheName       = 'advs_type';
    public $_tableName       = 'advs_type';
    public $_tablePrimaryKey = 'advs_type_id';
     ...
     * @access public
     */
    public function editType($type_id = null, $field_row)
    {
