...
class Increase_GoodsModel extends Increase_Goods
{
    ...
    public static $increases_goods_state_map = array(
        self::NORMAL => '正常',
        self::FINISHED => '已结束',
        self::CLOSED => '管理员关闭',
    );
    ...
    public function getIncreaseGoodsLists($cond_row, $order_row, $page = 1, $rows = 100)
    {
        $arr =  $this->listByWhere($cond_row, $order_row, $page, $rows);
        return $arr['items'];
    }
	...
	public function changeIncreaseGoodsUnnormal($increase_goods_id,$field_row)
	{
		$rs_row = array();
