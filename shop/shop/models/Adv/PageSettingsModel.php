			...
			else
			{
				if ($vals['type'] == "ad")
				{
					if (!empty($vals['html']))
					{
						...
						{
							// $click_url = YLB_Registry::get('base_url') . '/advertisement.php?ctl=Message_Adhtml&met=click&item_id='.$va['item_id'].'&url=http://' . urlencode($va['item_url']);
							$str .= "<li>";
							$str .= "<a target='_blank' href='" . $va['item_url'] . "'>";
