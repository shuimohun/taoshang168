...
class MessageModel extends Message
{
	 ...
	 * @access public
	 */
	public function sendMessage_bak($code, $message_user_id, $message_user_name, $order_id = NULL, $shop_name = NULL, $message_mold = 0, $message_type = 1, $end_time = Null,$common_id=NULL,$goods_id=NULL,$des=NULL, $start_time = Null,$goods_name=NULL,$av_amount=NULL,$freeze_amount=NULL)
	{
		$send_row['code'] = $code;
		...
		if($de['is_mail'] == 1)
        {
            ...
            if($de['force_mail'] == 1 || ($de['force_mail'] == 0 && $info == 1))
            {
                ...
                $me = str_replace("[weburl_url]", YLB_Registry::get('url'), $me);
		...
		if($de['is_phone'] == 1  && $mobile)
        {
            ...
            if($de['force_phone'] == 1  || ($de['force_phone'] == 0 && $info == 1))
            {
                ...
                $phone = str_replace("[weburl_url]", YLB_Registry::get('url'), $phone);
        ...
        if($de['is_email'] == 1  && $email)
        {
            ...
            if($de['force_email'] == 1  || ($de['force_email'] == 0 && $info == 1))
            {
                ...
                $emails = str_replace("[weburl_url]", YLB_Registry::get('url'), $emails);
