 ...
 * @todo
 */
class Shop_Template extends YLB_Model
{
	public $_cacheKeyPrefix  = 'c|shop_template|';
	public $_cacheName       = 'shop';
	public $_tableName       = 'shop_template';
	public $_tablePrimaryKey = 'shop_temp_name';
	 ...
	 * @access public
	 */
	public function getTemplate($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editTemplate($config_key = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editTemplateSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeTemplate($config_key)
	{
