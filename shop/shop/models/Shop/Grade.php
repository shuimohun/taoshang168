 ...
 * @todo
 */
class Shop_Grade extends YLB_Model
{
	public $_cacheKeyPrefix  = 'c|shop_grade|';
	public $_cacheName       = 'shop';
	public $_tableName       = 'shop_grade';
	public $_tablePrimaryKey = 'shop_grade_id';
	 ...
	 * @access public
	 */
	public function getGrade($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editGrade($config_key = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editGradeSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeGrade($config_key)
	{
