 ...
 * @todo
 */
class Shop_CompanyClass extends YLB_Model
{
	public $_cacheKeyPrefix  = 'c|shop_company_class|';
	public $_cacheName       = 'company_class';
	public $_tableName       = 'shop_company_class';
	 ...
	 * @access public
	 */
	public function addCompany_Class($field_row, $return_insert_id = false)
	{
	 ...
	 * @access public
	 */
	public function editCompany_Class($config_key = null, $field_row,$flag)
	{
	 ...
	 * @access public
	 */
	public function editCompany_ClassSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeCompany_Class($config_key)
	{
