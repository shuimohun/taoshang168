 ...
 * @todo
 */
class Shop_Express extends YLB_Model
{
	public $_cacheKeyPrefix  = 'c|shop_express|';
	public $_cacheName       = 'shop';
	public $_tableName       = 'shop_express';
	public $_tablePrimaryKey = 'user_express_id';
	 ...
	 * @access public
	 */
	public function getExpress($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editExpress($config_key = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editExpressSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeExpress($config_key)
	{
