 ...
 * @todo
 */
class Shop_Nav extends YLB_Model
{
	public $_cacheKeyPrefix  = 'c|shop_nav|';
	public $_cacheName       = 'shop';
	public $_tableName       = 'shop_nav';
	public $_tablePrimaryKey = 'id';
	public $htmlKey          = array('detail');
	 ...
	 * @access public
	 */
	public function getNav($config_key = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editNav($config_key = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editNavSingleField($config_key, $field_name, $field_value_new, $field_value_old)
	{
	 ...
	 * @access public
	 */
	public function removeNav($config_key)
	{
