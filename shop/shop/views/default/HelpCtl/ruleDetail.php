    ...
    <div class="l-wrap">
        <div class="l-main">
            <div class="breadcrumb">
                <span class="i-txt">
                    <a href="<?= YLB_Registry::get('url') . '?ctl=Help&met=index' ?>">首页</a>
                </span>
                &nbsp;&gt;&nbsp;
                <a href="<?= YLB_Registry::get('url') . '?ctl=Help&met=ruleOverview&id=' ?><?= ($group_id)?>"> <span class="i-txt"><?= $group_title?></span></a>
                &nbsp;&gt;&nbsp;
...
<!--                        我有疑问，我要在线咨询-->
<!--                    </a>-->
                    <a href="<?= YLB_Registry::get('url') . '?ctl=Help&met=index'?>" class="link-underline"> <i class="icon-more"></i>
                        我还想看更多相关帮助
                    </a>
                </div>
            </div>
