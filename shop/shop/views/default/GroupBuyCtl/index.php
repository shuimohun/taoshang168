...
<div class="wrap">
	...
	<div class="groups">
		<h3>
            <a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList"><?=_('线上团')?></a><i><?=_('每天整点开抢')?></i>
            <span class="more"> <a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=groupBuyList"><?=_('更多')?><i class="iconfont icon-iconjiantouyou"></i></a></span>
        </h3>
            <?php
                ...
                <div class="gr_goods clearfix">
                    ...
                    <div class="gr_goods_imfor">
                        <div class="gr_goods_div">
                            <h4><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$data['goods']['physical']['highly_recommend']['groupbuy_id']?>"><?= $data['goods']['physical']['highly_recommend']['groupbuy_name'] ?></a></h4>
                            <ul>
                            ...
                            <div class="gr_good_price clearfix">
                                ...
                                <a class="bbc_btns" href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$data['goods']['physical']['highly_recommend']['groupbuy_id']?>"><?=_('立即购买')?><i class="iconfont icon-iconjiantouyou"></i></a>
                            </div>
                            <div class="gr_good_lastime clearfix fnTimeCountDown" data-end="<?=$data['goods']['physical']['highly_recommend']['groupbuy_endtime']?>">
                                ...
                                <em><strong class="bbc_color"><?=$data['goods']['physical']['highly_recommend']['groupbuy_virtual_quantity'] ?></strong> <?=_('人已付款')?></em>
                            </div>
                        </div>
                        <p class="hotbg"></p>
                    </div>
		...
		<ul class="gr_goods_list clearfix">
            <?php  foreach($data['goods']['physical']['recommend']['items'] as $key=>$value) { ?>
                <li>
                    ...
                    <h5>
                        <a href="<?= YLB_Registry::get('url') ?>?ctl=GroupBuy&met=detail&id=<?= $value['groupbuy_id'] ?>"><?= $value['groupbuy_name'] ?></a>
                    </h5>

                    <p class="gr_sold_hav clearfix"><span><?= _('已售') ?><i class="num-color ml4"><?= $value['groupbuy_buy_quantity'] ?></i></span>
	...
	<div class="groups">
		<h3>
            <a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList"><?=_('虚拟团')?></a><i><?=_('每天整点开抢')?></i>
            <span class="more"> <a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList"><?=_('更多')?><i class="iconfont icon-iconjiantouyou"></i></a></span>
        </h3>
            <?php
        ...
        ?>
            <div class="gr_goods clearfix">
                ...
                <div class="gr_goods_imfor">
                    <div class="gr_goods_div">
                        <h4><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$data['goods']['virtual']['highly_recommend']['groupbuy_id']?>"><?= $data['goods']['virtual']['highly_recommend']['groupbuy_name'] ?></a></h4>
                        <ul>
                        ...
                        <div class="gr_good_price clearfix">
                            ...
                            <a  class="bbc_btns" href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$data['goods']['virtual']['highly_recommend']['groupbuy_id']?>"><?=_('立即购买')?><i class="iconfont icon-iconjiantouyou"></i></a>
                        </div>
                        <div class="gr_good_lastime clearfix fnTimeCountDown" data-end="<?=$data['goods']['virtual']['highly_recommend']['groupbuy_endtime']?>">
                            ...
                            <em><strong class="bbc_color"><?=$data['goods']['virtual']['highly_recommend']['groupbuy_virtual_quantity'] ?></strong> <?=_('人已付款')?></em>
                        </div>
                    </div>
                    <p class="hotbg"></p>
                </div>
		...
		<ul class="gr_goods_list clearfix">
            <?php  foreach($data['goods']['virtual']['recommend']['items'] as $key=>$value) {
                    ?>
                    <li>
                        <a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$value['groupbuy_id']?>" class="gr_goods_a"><img src="<?=image_thumb($value['groupbuy_image'],206,230)?>"/></a>
                        ...
                        <h5><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=detail&id=<?=$value['groupbuy_id']?>"><?=$value['groupbuy_name']?></a></h5>
                        <p class="gr_sold_hav clearfix"><span><?=_('已售')?><i class="num-color ml4"><?=$value['groupbuy_buy_quantity']?></i></span>
                            <em class="fnTimeCountDown" data-end="<?=$value['groupbuy_endtime']?>">
                                <span class="day" >00</span><strong><?=_('天')?></strong>
                                <span class="hour">00</span><strong><?=_('小时')?></strong>
