...
<div class="aright">
      <div class="member_infor_content">
        <div class="tabmenu">
          <ul class="tab">
			<li class="active"><a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_User&met=address"><?=_('收货地址')?></a></li>
			</ul>
</div>
<div class="order_content_title clearfix">
<div class="clearfix" style="margin-top: 10px;">
<div class="ptkf bbc_btns">
 <!-- <a class="bbc_bg" href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_User&met=address&act=edit_delivery" class="ncbtn ncbtn-bittersweet" style="right: 100px;" nc_type="dialog" dialog_title="<?=_('使用代收货（自提）')?>" dialog_id="daisou" uri="index.php?act=member_address&amp;op=delivery_add" dialog_width="900" title="<?=_('使用自提服务站')?>"><?=_('使用自提服务站')?></a>-->
<a class="" href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_User&met=address&act=add" nc_type="dialog" dialog_title="<?=_('新增地址')?>" dialog_id="my_address_edit" uri="index.php?act=member_address&amp;op=address&amp;type=add" dialog_width="550" title="<?=_('新增地址')?>"><?=_('新增地址')?></a>
</div>
</div>
</div>
<table class="ncm-default-table annoc_con">
	...
	<td><?php if($val['user_address_default']=='1'){?><i class="iconfont icon-icoselectturn greenxue" style="font-size: 18px;"></i><?=_('默认地址')?><?php } ?></td>
        ...
        <span class="edit"><a  class="btn-bluejeans" dialog_id="my_address_edit" dialog_width="550" dialog_title="<?=_('编辑地址')?>"  href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_User&met=address&id=<?=$val['user_address_id'] ?>&act=edit"><i class="iconfont icon-zhifutijiao"></i><p><a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_User&met=address&id=<?=$val['user_address_id'] ?>&act=edit"><?=_('编辑')?></a></p></a></span>
