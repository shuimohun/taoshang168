    ...
    <div class="order_content_title clearfix">
        <div style="margin-top: 10px;" class="clearfix">
            <div class="ptkf bbc_btns">
                <a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Service_Custom&met=index&act=add&typ=e"><?=_('平台客服')?></a>
            </div>
        </div>
    </div>
        ...
        <table style="width: 100%;" class="icos bort">
            ...
            foreach ($data['items'] as $key => $value)
            {
                ...
                <tr>
                    ...
                    <?php } ?>
                    <td class="td_4"><p><span class="edit"><a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Service_Custom&met=index&act=detail&id=<?= $value['custom_service_id'] ?>"><i class="iconfont icon-chakan"></i><?=_('查看')?></a></span>
