                ...
                <table>
                    <tr>
                        ...
                        <td style="width:88%; text-align: left;">
                            <a target="_blank" href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$data['goods']['goods_id']?>"><?=$data['goods']['goods_name']?></a>
                        </td>
                    </tr>
                    <tr>
                        <td><?=_('举报类型：')?></td>
...
<!--                                <div id="fileList" class="uploader-list"></div>-->
                                 ...
                                 <div class="upload_img" id="filePicker"><i class="iconfont icon-jia"></i><?=_('上传证据')?></div>
