        ...
        <table class="complaint icos">
            ...
            foreach ($data['items'] as $key => $value)
            {
                ...
                <tr>
                    ...
                    <td width="345" style="text-align: left;"><a target="_blank" href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $value['good']['goods_id'] ?>"><?= $value['good']['goods_name'] ?></a></td>
