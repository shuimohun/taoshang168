            ...
            <div class="ncm-flow-layout" id="ncmComplainFlow">
                ...
                <div class="ncm-flow-item">
                    ...
                    <div class="item-goods">
                        <dl>
                            <dd><a target="_blank"
                                   href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $data['ordergoods']['goods_id'] ?>"><?= $data['ordergoods']['goods_name'] ?></a>
                    ...
                    <div class="item-order">
                        ...
                        <dl class="line">
                            <dt><?= _('订单编号：') ?></dt>
                            <dd>
                                <a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Order&met=physical&act=details&order_id=<?= $data['order']['order_id'] ?>"
