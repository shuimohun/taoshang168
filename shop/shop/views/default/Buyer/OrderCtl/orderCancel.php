...
<style>
    .eject_con{background-color:#FFF;overflow:hidden;font:12px/20px "Hiragino Sans GB","Microsoft Yahei",arial,宋体,"Helvetica Neue",Helvetica,STHeiTi,sans-serif}
    .eject_con dl{font-size:0;line-height:20px;display:block;clear:both;overflow:hidden}
    .eject_con dl dd{font-size:12px;line-height:32px;vertical-align:top;letter-spacing:normal;word-spacing:normal;display:inline-block;width:69%;padding:10px 0 10px 0;zoom:1;margin-left:0}
    .eject_con dl dt{font-size:12px;line-height:32px;vertical-align:top;letter-spacing:normal;word-spacing:normal;text-align:right;display:inline-block;width:29%;padding:10px 1% 10px 0;margin:0;zoom:1}
    ...
    .radio,input[type=radio]{display:inline-block;margin-right:5px}
    .textarea,textarea{font:12px/18px Arial;color:#777;background-color:#FFF;vertical-align:top;display:inline-block;height:40px;padding:4px;border:solid 1px #CCD0D9;outline:0 none}
</style>
</head>
<body>
