          ...
          <form id="goodsevalform" method="get" class="tc">
            ...
            <div class="evaluation-timeline clearfix">
                ...
                <?php if(!isset($value[1])):?>
                  <span>
                    <a class="btnredpj bbc_seller_btns" href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Order&met=evaluation&act=again&oge_id=<?=($value[0]['evaluation_goods_id'])?>"  id="explain"><i class=" bbc_seller_btns iconfont icon-shangjiaruzhushenqing icon_size16"></i><?=_('追加评价')?></a>
                  </span>
                <?php endif;?>
