            ...
            <div class="evaluation-timeline logistics_mes clearfix" style="margin-bottom: 50px;">
                ...
                <div class="date clearfix">
                    ...
                    <div class="goods_image">
                        <a target="_blank" href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=($data['goods_base']['goods_id'])?>">
                    ...
                    <div class="order_goods">
                        <!-- 商品名称 -->
                        <a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=($data['goods_base']['goods_id'])?>"><?=($data['goods_base']['goods_name'])?></a>
                        <!-- 商品价格 -->
                    ...
                    $.ajax({
                        ...
                        success:function(a){
                            if(a.status == 200)
                            {
                                ...
                                location.href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Order&met=evaluation";
                            }
                            else
                            {
                                if(a.msg != 'failure')
