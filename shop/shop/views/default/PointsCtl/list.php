...
<div class="bbc-breadcrumb-layout">
	<div class="bbc-breadcrumb wrapper"><i class="icon-home"></i> <span><a href="<?=YLB_Registry::get('url')?>">首页</a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span> <span><a href="<?=YLB_Registry::get('url')?>?ctl=Points&met=index">金蛋商城</a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span> <span><a href="<?=YLB_Registry::get('url')?>?ctl=Points&met=pList">兑换礼品列表</a></span> </div>
</div>
		...
		<div class="bbc-category">
			<dl class="searchbox">
				...
				<ul>
                    ...
                    <li op_type="search_orderby" class="<?=(request_string('orderby')=='pointsdesc' || request_string('orderby')=='pointsasc')?'hova':''?>" onclick='list(<?=request_string('orderby')=='pointsdesc'?'"pointsasc"':'"pointsdesc"'?>)'><?=_('金蛋值')?>
