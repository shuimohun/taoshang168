...
<div class="bbc-breadcrumb-layout">
    <div class="bbc-breadcrumb wrapper"><i class="icon-home"></i>
        <span><a href="<?=YLB_Registry::get('url')?>"><?=_('首页')?></a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span>
        <span><a href="<?=YLB_Registry::get('url')?>?ctl=Points&met=index"><?=_('金蛋商城')?></a></span><span class="arrow"><i class="iconfont icon-iconjiantouyou"></i></span>
        <span><?=_('兑换礼品详情')?></span>
    </div>
</div>
	...
	<div class="bbc-detail">
		...
		<div class="bbc-gift-summary">
			...
			<div class="bbc-meta">
				...
				<dl>
					<dt><?=_('所需金蛋')?>：</dt>
					<dd class="points"> <strong><em class="bbc_color"><?=$data['goods_detail']['points_goods_points']?></em> <?=_('金蛋')?></strong><span class="bbc_btns"><?=$data['goods_detail']['points_goods_limitgrade_label']?><?=_('专享')?></span></dd>
				</dl>
            </div>
			<div class="bbc-key">
				<dl>
			...
			<div class="bbc-sidebar-container">
				...
				<div class="content">
					<ul class="recommend">
						...
						<li>
							<div class="gift-pic">
								<a target="_blank" href="<?=YLB_Registry::get('url')?>?ctl=Points&met=detail&id=<?=$value['points_goods_id']?>" title="<?=$value['points_goods_tag']?>">
							...
							<div class="pgoods-points">
								<span class="bbc_color"><?=$value['points_goods_points']?></span><?=_('金蛋')?>
