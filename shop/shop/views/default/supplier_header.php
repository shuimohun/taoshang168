...
$search_words = array_map(function($v) {
	return sprintf('<a href="%s?ctl=Supplier_Goods&met=goodslist&typ=e&keywords=%s" class="cheap">%s</a>', YLB_Registry::get('url'), urlencode($v), $v);
...
<div class="wrap">
	<div class="head_cont">
		...
		<div class="nav_left">
			<a href="<?=YLB_Registry::get('url')?>?ctl=Supplier_Index&met=index" class="logo"><img src="<?=@$this->web['supplier_logo']?>"/></a>
	...
	<div>
		<div class="thead clearfix">
            ...
            <?php if($this->is_index){?>
                <div class="wrap t_cont clearfix" style="float: right;z-index:999;">
