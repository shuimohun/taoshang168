...
<div class="tabmenu">
    <ul>
        <li><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Seller_Group&met=groupList&typ=e"><?=_('组列表')?></a></li>
        <li  class="active bbc_seller_bg"><a href="javascript:void(0);"><?=_('添加账号')?></a></li>
    </ul>
</div>
