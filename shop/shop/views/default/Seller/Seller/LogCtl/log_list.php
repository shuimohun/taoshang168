...
<div class="tabmenu">
    <ul>
        <li class="active bbc_seller_bg"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Seller_Log&met=logList&typ=e"><?=_('日志列表')?></a></li>
    </ul>
</div>
...
<div class="search fn-clear">
    <div id="search_form">
        <form id="form" action="index.php" method="get">
            ...
            <a class="button refresh" href="<?=YLB_Registry::get('url')?>?ctl=Seller_Seller_Log&met=logList&typ=e&"><i class="iconfont icon-huanyipi"></i></a>
            ...
            <input type="text" value="" placeholder="<?=_('日志内容')?>" class="text w200" name="log_content">
            <input type="text" value="" placeholder="<?=_('账号')?>" class="text w100" name="seller_name">
        </form>
...
<table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <th width="50"></td>
        <th class="tl" width="300"><?=_('账号')?></th>
        <th class="tl"><?=_('日志内容')?></th>
        <th width="80"><?=_('状态')?></th>
        <th width="110"><?=_('ip')?></th>
        <th width="130"><?=_('时间')?></th>
    </tr>
    <?php
    if($data['items'])
    {
