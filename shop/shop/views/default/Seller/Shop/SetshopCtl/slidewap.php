...
?>
 ...
 <div class="alert">
        <ul>
            ...
            <li><?=_('2、支持jpg、jpeg、gif、png格式上传，建议图片宽度800px、高度200px、大小1.00M以内的图片。提交2~5张图片可以进行幻灯片播放，一张图片没有幻灯片播放效果。')?></li>
...
<script>
    $(document).ready(function(){
        var ajax_url = './index.php?ctl=Seller_Shop_Setshop&met=editSlideWap&typ=json';
        $('#form').validator({
            ignore: ':hidden',
            theme: 'yellow_right',
            timely: 1,
