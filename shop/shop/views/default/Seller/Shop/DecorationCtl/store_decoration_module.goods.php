...
<ul class="goods-list">
  <?php foreach($goods_list as $key=>$val){?>
    <?php $goods_url = "index.php?ctl=Goods_Goods&met=goods&type=goods&gid=".$val['goods_id'];?>
    ...
    <dl class="goods-info">
      <dt><a  target="_blank" title="<?php echo $val['common_name'];?>" href="<?php echo $goods_url;?>"><?php echo $val['common_name'];?></a></dt>
