        ...
        <div style="width:100%;">
            ...
            foreach ($data as $key => $value)
            {
                ...
                <div style="float: left; width: 50%;">
                    ...
                    <div style="width: 100%;">
                        <div
                            style="min-height: 60px; margin-right: 10px; padding: 10px; color: #9c9c9c; border: 1px solid #f5f5f5;height: 120px;overflow: hidden;"><?= $value['contract_type_desc'] ?></div>
