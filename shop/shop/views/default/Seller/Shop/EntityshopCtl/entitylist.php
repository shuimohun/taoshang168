...
?>
        ...
        <div class="tabmenu">
            <ul>
                    <li ><a href="./index.php?ctl=Seller_Shop_Entityshop&met=entityShop&typ=e"><?=_('地图显示')?></a></li>
                   
                    <li class="active bbc_seller_bg"><a href="./index.php?ctl=Seller_Shop_Entityshop&met=entityShop&typ=e&act=list"><?=_('列表显示')?></a></li>
        ...
        <tr>
            <th class="tl"><?=_('实体店铺名称')?></th>
            <th ><?=_('电话')?></th>
            <th ><?=_('详细地址')?></th>
            <th width="320"><?=_('公交')?></th>
        ...
        <tr class="row_line">
            ...
            <td width="120" class="nscs-table-handle">
                <span class="edit"><a class="edit_map" data-id="<?= $value['entity_id'] ?>"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
                <span class="del"><a data-param="{'ctl':'Seller_Shop_Entityshop','met':'delEntity','id':'<?= $value['entity_id'] ?>'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i>删除</a></span>
            </td>
        </tr>
