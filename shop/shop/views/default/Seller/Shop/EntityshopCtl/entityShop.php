...
?>
        ...
        <div class="tabmenu">
            <ul>
                    <li class="active bbc_seller_bg"><a href="./index.php?ctl=Seller_Shop_Entityshop&met=entityShop&typ=e"><?=_('地图显示')?></a></li>
                   
                    <li ><a href="./index.php?ctl=Seller_Shop_Entityshop&met=entityShop&typ=e&act=list"><?=_('列表显示')?></a></li>
               
                 
            </ul>
                <a class="button add button_blue bbc_seller_btns"  id="add_map" ><i class="iconfont icon-jia"></i><?=_('添加实体店铺')?></a>
           </div>    
                <div class="alert">
                    <ul>
                        <li><?=_('1、系统借助“百度地图”进行定位，使用时要确保网络能正常访问。')?></li>
                        <li><?=_('2、由于地图的窗口大小限制，最多可添加20个地址。可在“列表显示”中修改和删除已添加的地址。')?></li>
                    </ul>
                </div>
<?php
?>
