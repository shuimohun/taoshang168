                ...
                <form id="form_company_info"  method="post">
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <th><i>*</i>执照类型：</th>
                                <td>
                                    <select name="shop_license_type" id="shop_license_type">
                                        <?php foreach (Shop_CompanyModel::$shop_license_type as $key=>$value){?>
                                            <option value="<?=$key?>" <?php if(isset($shop_company['shop_license_type'])&&$shop_company['shop_license_type']==$key){echo 'selected="selected"';}?>><?=$value?></option>
                                        <?php }?>
                                    </select>
                                    <span></span>
                                </td>
                            ...
                            <tr>
                                <th><i>*</i>公司名称：</th>
                                <td><input name="shop_company_name" class="text w200" type="text" value="<?php echo isset($shop_company['shop_company_name']) ? $shop_company['shop_company_name'] : '';?>">
                                    <span></span>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <th><i>*</i>营业执照号：</th>
                                <td><input name="business_id" class="text w200" type="text" value="<?php echo isset($shop_company['business_id']) ? $shop_company['business_id'] : '';?>">
                                    <span></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="province_id" class="id_1" value="<?php echo isset($yingye_district_info['district_info'][0]['district_id']) ? $yingye_district_info['district_info'][0]['district_id'] : '';?>" />
                                    <input type="hidden" name="city_id" class="id_2" value="<?php echo isset($yingye_district_info['district_info'][1]['district_id']) ? $yingye_district_info['district_info'][1]['district_id'] : '';?>" />
                                    <input type="hidden" name="area_id" class="id_3" value="<?php echo isset($yingye_district_info['district_info'][2]['district_id']) ? $yingye_district_info['district_info'][2]['district_id'] : '';?>" />
                                    <input type="hidden" name="street_id" class="id_4" value="<?php echo isset($yingye_district_info['district_info'][3]['district_id']) ? $yingye_district_info['district_info'][3]['district_id'] : '';?>" />
                                    <div id="d_2">
                                        <select class="select_1" name="yingye_1" onChange="district(this);">
                                            <option value="">--请选择--</option>
                                            <?php foreach($district['items'] as $key=>$val){ ?>
                                                <option value="<?php echo $val['district_id'];?>|1" <?php if(isset($yingye_district_info['district_info'][0]['district_id']) && $val['district_id'] == $yingye_district_info['district_info'][0]['district_id']){echo 'selected="selected"';} ?> > <?=$val['district_name']?></option>
                                            <?php } ?>
                                        </select>
                                        ...
                                        <?php if(isset($yingye_district_info['district_list'][3])){?>
                                            <select class="select_3" name="yingye_3" onChange="district(this);" >
                                                <?php foreach($yingye_district_info['district_list'][3] as $key=>$val){ ?>
                                                    <option value="<?php echo $val['district_id'];?>|3" <?php if(isset($yingye_district_info['district_info'][2]['district_id']) && $val['district_id'] == $yingye_district_info['district_info'][2]['district_id']){echo 'selected="selected"';} ?> > <?=$val['district_name']?></option>
                                                <?php } ?>
                                            </select>
                                        <?php }else{ ?>
                                            <select class="select_3 hidden" name="yingye_3" onChange="district(this);" ></select>
                                        <?php } ?>
                                        <?php if(isset($yingye_district_info['district_list'][4])){?>
                                            <select class="select_4" name="yingye_4" onChange="district(this);" >
                                                <?php foreach($yingye_district_info['district_list'][4] as $key=>$val){ ?>
                                                    <option value="<?php echo $val['district_id'];?>|4" <?php if(isset($yingye_district_info['district_info'][3]['district_id']) && $val['district_id'] == $yingye_district_info['district_info'][3]['district_id']){echo 'selected="selected"';} ?> > <?=$val['district_name']?></option>
                                                <?php } ?>
                                            </select>
                                        <?php }else{ ?>
                                            <select class="select_4 hidden" name="yingye_4" onChange="district(this);" ></select>
                                        <?php } ?>
                                    </div>
                                    <span></span>
                                </td>
                            ...
                            <tr>
                                <th><i>*</i>营业执照有效期：</th>
                                <td>
                                    <input readonly="readonly"  id="start_time"  name="business_licence_start"  class="text w90 hasDatepicker" type="text" value="<?php echo isset($shop_company['business_licence_start']) ? $shop_company['business_licence_start'] : '';?>"><em><i class="iconfont icon-rili"></i></em>
                                    -
                                    <input readonly="readonly" id="end_time" name="business_licence_end" class="text w90 hasDatepicker" type="text" value="<?php echo isset($shop_company['business_licence_end']) && ($shop_company['business_licence_end'] > $shop_company['business_licence_start']) ? $shop_company['business_licence_end'] : '';?>"><em><i class="iconfont icon-rili"></i></em>
                                    <span class="block">结束时间不填代表永久。</span>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i>营业执照电子版：</th>
                                <td>
                                    <input  style="float:left;" id="business_logo" readonly="readonly"  name="business_license_electronic" type="text" class="text mr10" value="<?php echo isset($shop_company['business_license_electronic']) ? $shop_company['business_license_electronic'] : '';?>">
                                    <p style="float:left; width:70px;height: 28px !important;" id="business_upload" >上传图片</p>
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <th><i>*</i>组织机构代码：</th>
                                <td><input name="organization_code" class="text w200" type="text" value="<?php echo isset($shop_company['organization_code']) ? $shop_company['organization_code'] : '';?>">
                                    <span></span></td>
                            </tr>
                            <tr>
                                <th><i>*</i>组织机构代码证电子版：</th>
                                <td><input  style="float:left;"id="organization_logo" readonly="readonly" name="organization_code_electronic" type="text" class="text mr10" value="<?php echo isset($shop_company['organization_code_electronic']) ? $shop_company['organization_code_electronic'] : '';?>">
                                    <p style="float:left; width:70px;height: 28px !important;" id="organization_upload" >上传图片</p>
                                    <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章</span>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input  style="float:left;"id="general_logo" readonly="readonly" name="general_taxpayer" type="text" class="text mr10" value="<?php echo isset($shop_company['general_taxpayer']) ? $shop_company['general_taxpayer'] : '';?>">
