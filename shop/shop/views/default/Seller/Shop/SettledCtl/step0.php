...
<div class="main">
		<div class="modular-select">
			<h2 class="index-title"><?=_('选择个人或者企业商家入驻')?></h2>
			<ul class="settled-object">
				<li>
					...
					<a href="index.php?ctl=Seller_Shop_Settled&met=index&op=step1&apply=1" class="btn btn-apply"><?=_('立即申请')?></a>
				</li>
				<li>
					<div>
					...
					<a href="index.php?ctl=Seller_Shop_Settled&met=index&op=step1&apply=2" class="btn btn-apply"><?=_('立即申请')?></a>
				</li>
			</ul>
		</div>
	</div>
