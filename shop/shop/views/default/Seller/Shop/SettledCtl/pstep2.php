...
<div class="breadcrumb"><span class="icon-home iconfont icon-tabhome"></span><span><a href="index.php"><?=_('首页')?></a></span> <span class="arrow iconfont icon-btnrightarrow"></span> <span><?=_('个人入驻申请')?></span> </div>
<div class="main">
    <div class="sidebar">
        <div class="title">
            <h3><?=_('个人入驻申请')?></h3>
        ...
        <div class="content">
            <dl show_id="99">
                ...
                <dd style="display:none;">
                    <ul>
                        ...
                        <li> <i></i> <a href="" target="_blank"><?=_('个人信息提交')?></a> </li>
                        <li> <i></i> <a href="" target="_blank"><?=_('平台审核资质')?></a> </li>
                        <li> <i></i> <a href="" target="_blank"><?=_('个人缴纳费用')?></a> </li>
            ...
            <dl show_id="0">
                ...
                <dd>
                    <ul>
                        <li class="bbc_bg_col"><i></i><?=_('个人实名信息')?></li>
    ...
    <div class="right-layout">
        <div class="joinin-step">
            <ul>
                ...
                <li class="current"><span><?=_('个人实名信息')?></span></li>
        ...
        <div class="joinin-concrete">
            <div id="apply_company_info" class="apply-company-info">
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <th><i>*</i><?=_('真实姓名')?>：</th>
                                <td>
                                    <input name="contacts_name" class="text w200" type="text" id="contacts_name" value="<?php echo isset($shop_company['contacts_name']) ? $shop_company['contacts_name'] : '';?>" />
                                    <span></span>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i><?=_('手机号码')?>：</th>
                                <td>
                                    <input name="contacts_phone" class="text w200" type="text" id="contacts_phone" value="<?php echo isset($shop_company['contacts_phone']) ? $shop_company['contacts_phone'] : '';?>" />
                                    <span></span><input type="button" onclick="getyzm('phone')" data-type="phone" value="<?=_('获取手机验证码')?>" id ='phone_yzm_bn'/>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i><?=_('手机验证码')?>：</th>
                                <td>
                                    <input name="phone_verify" class="text w200" type="text">
                                    <span></span>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i><?=_('邮箱')?>：</th>
                                <td>
                                    <input name="contacts_email" class="text w200" type="text" id='contacts_email' value="<?php echo isset($shop_company['contacts_email']) ? $shop_company['contacts_email'] : '';?>" />
                                    <span></span>
                                </td>
                            </tr>
                            <!--<tr>
                                <th><i>*</i><?/*=_('邮箱验证码')*/?>：</th>
                                <td>
                                    <input name="email_verify" class="text w200" type="text">
                                    <span></span><input type="button" onclick="getyzm('email')" data-type="email" value="<?/*=_('获取邮箱验证码')*/?>" id ='email_yzm_bn' />
                                </td>
                            </tr>-->
                            <tr>
                                <th><i>*</i><?=_('店铺所在地')?>：</th>
                            ...
                            <tr>
                                <th><i>*</i><?=_('详细地址')?>：</th>
                                <td>
                                    <input name="company_address_detail" value="<?php echo isset($shop_company['company_address_detail']) ? $shop_company['company_address_detail'] : '';?>" class="text w200" type="text">
                                    <span></span>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <select name="legal_identity_type" id="legal_identity_type">
                                        <option value="1" <?php if($shop_company['legal_identity_type'] == 1){echo 'selected="selected"';}?>><?=_('身份证')?></option>
                                        <option value="2" <?php if($shop_company['legal_identity_type'] == 2){echo 'selected="selected"';}?>><?=_('护照')?></option>
                                        <option value="3" <?php if($shop_company['legal_identity_type'] == 3){echo 'selected="selected"';}?>><?=_('军官证')?></option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i><?=_('证件号码')?>：</th>
                                <td>
                                    <input name="business_id" class="text w200" type="text" id="business_id" value="<?php echo isset($shop_company['legal_person_number']) ? $shop_company['legal_person_number'] : '';?>" />
                                    <span></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="block"><?=_('结束时间不填代表永久。')?></span>
                                </td>
                            </tr>
                            <tr>
                                <th><i>*</i><?=_('正面照预览：')?></th>
                                <td>
                                    ...
                                    <p class="hint mt5"><span style="color:orange;"><?=_('正面照尺寸为300x200像素，请根据系统操作提示进行裁剪并生效。')?></span></p>
                            ...
                            <tr>
                                <th><i>*</i><?=_('手持证件照预览')?>：</th>
                                <td>
                                    <div class="user-avatar"><span><img  id="image_hand_img"  src="<?php echo isset($shop_company['legal_person_electronic3']) ? $shop_company['legal_person_electronic3'] : '';?>" width="300" height="200" nc_type="avatar"></span></div>
                                    <p class="hint mt5"><span style="color:orange;"><?=_('正面照尺寸为300x200像素，请根据系统操作提示进行裁剪并生效。')?></span></p>
                                    <input name="user_identity_hand_logo" id="user_identity_hand_logo" type="hidden" value="<?php echo isset($shop_company['legal_person_electronic3']) ? $shop_company['legal_person_electronic3'] : '';?>" />
                ...
                <div class="bottom"><a href="<?= YLB_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=step1&rp=step1&apply=1" class="btn bbc_btns"><?=_('上一步')?></a>&nbsp;&nbsp;&nbsp;<a id="btn_apply_company_next" href="javascript:;" class="btn bbc_btns"><?=_('下一步，提交财务资质信息')?></a></div>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var ajax_url = SITE_URL + '?ctl=Seller_Shop_Settled&met=addShopCompany&typ=json&apply=<?=$apply?>';
            ...
            valid:function(form){
                ...
                $.ajax({
                    ...
                    success:function(a){
                        if(a.status == 200)
                        {
                            location.href = SITE_URL + "?ctl=Seller_Shop_Settled&met=index&op=step3&apply=<?=$apply?>";
                        }
                        else
                        {
                            if(a.data.msg){
    ...
    function email_yzm_count() {
        delayTimeEmail--;
        $("#email_yzm_bn").val(delayTimeEmail + "<?=_('秒后重新获取')?>");
        if (delayTimeEmail == 0) {
            delayTimeEmail = 60;
            $("#email_yzm_bn").val("<?=_('获取邮箱验证码')?>");
    ...
    function phone_yzm_count() {
        delayTime--;
        $("#phone_yzm_bn").val(delayTime + "<?=_('秒后重新获取')?>");
        if (delayTime == 0) {
            delayTime = 60;
            $("#phone_yzm_bn").val("<?=_('获取手机验证码')?>");
