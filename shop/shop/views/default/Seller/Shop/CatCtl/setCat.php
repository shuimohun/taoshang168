...
<body>
    ...
    <div class="form-style">
        ...
        <dl class="dl">
         ...
         <dl class="dl">
            <dt><?=_('是否显示：')?></dt>
            <dd >  <label class="radio status"><input type="radio"  <?=($data['shop_goods_cat_status'] ? 'checked' : '') ?> name="cat[shop_goods_cat_status]" id="status"  value="1" /><?=_('是')?></label> <label class="radio status"><input type="radio"  name="cat[shop_goods_cat_status]" <?=(!$data['shop_goods_cat_status'] ? 'checked' : '') ?> value="0" /><?=_('否')?></label></dd>
        </dl>
       <dl class="dl">
            <dt><i></i><?=_('排序：')?></dt>
