       ...
       <table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr class="row_line">
            ...
            <td class="nscs-table-handle">
                ...
                <span class="delparent" ><a data-param="{'ctl':'Seller_Shop_Cat','met':'delCat','id':'<?=$value['shop_goods_cat_id']?>'}" href="javascript:void(0)"><i class="iconfont icon-lajitong"></i><?=_('删除')?></a></span>
