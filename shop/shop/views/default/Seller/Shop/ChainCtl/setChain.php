...
<body>
	...
	<div class="tabmenu">
		<ul>
        	<li ><a href="./index.php?ctl=Seller_Shop_Chain&met=chain&typ=e"><?=_('门店列表')?></a></li>

            <?php if($act == 'add') {?>
    <li  class="active bbc_seller_bg"><a href="javascript:void(0);"><?=_('添加门店')?></a></li>
<?php }
if($act == 'edit'){?>
    <li class="active bbc_seller_bg"><a href="javascript:void(0);"><?=_('编辑门店')?></a></li>
<?php }?>
        </ul>
    ...
    <?php if($act == 'add') {?>
        <div class="alert">
            <ul>
                <li>1、可添加多个门店,同时管理。</li>
                <li>2、<strong class="bbc_seller_color">所填门店信息真实准确。</strong></li>
            </ul>
        </div>
        <form method="post" action="#" id="form" enctype="multipart/form-data">
            <div class="ncsc-form-default">
                <h3>门店账户注册</h3>
                <dl class="dl">
                    <dt><i class="required">*</i>登录名：</dt>
                    <dd>
                        <input type="text" class="text w200" name="chain_user" id="chain_user" value="">
                        <p class="hint">登录名请使用中文、字母、数字、下划线（最低三个字符）。</p>
                    </dd>
                </dl>
                <dl class="dl">
                    <dt>
                ...
                <dl class="dl">
                    ...
                    <dd>
                        ...
                        <div><p class="hint">将您的实体店面沿街图上传，方便用户（购物者）线下到店自提时能最准确直观的找到您的门店。</p></div>
                    </dd>
                </dl>
                <dl class="dl">
                    <dt></dt>
...
if($act == 'edit' && $data){?>
    <div class="alert">
        <ul>
             <li><strong class="bbc_seller_color">所填门店信息真实准确。</strong></li>
        </ul>
    </div>
    <form method="post" action="#" id="form" enctype="multipart/form-data">
        <div class="ncsc-form-default">
            ...
            <dl class="dl">
                ...
                <dd>
                    ...
                    <?php if(@$data['chain_area']){ ?>
                        <div id="d_1"><?=@$data['chain_area'] ?>&nbsp;&nbsp;<a href="javascript:sd();"><?=_('编辑')?></a></div>
                    <?php } ?>
