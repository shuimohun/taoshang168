...
<div class="breadcrumb"><span class="icon-home iconfont icon-tabhome"></span><span><a href="index.php">首页</a></span> <span class="arrow iconfont icon-btnrightarrow"></span> <span><?=_($apply_tips['0'])?></span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
  ...
  <div class="right-layout">
      ...
      <div class="joinin-step">
        <ul>
          ...
          <li class="current"><span>店铺经营信息</span></li>
            <li class="current"><i></i>店铺经营类目信息</li>
    ...
    <table cellpadding="0" cellspacing="1" width="100%">
        <tbody><tr>
            <td width="70">上传凭证：</td>
            <td>
                <input class="text w250" style="float: left;"  id="payment_voucher" readonly="readonly"name="payment_voucher" type="text" value="<?php echo isset($shop_company['payment_voucher']) ? $shop_company['payment_voucher'] : '';?>"> <p style="float:left; width:70px;margin-left:10px;"  id="payment_upload" ><i class="iconfont icon-upload-alt"></i>图片上传</p>
            </td>
        </tr>
        <tr>
            <td>备注：</td>
    ...
    <div class="next">
<!--        <a href="--><?//= YLB_Registry::get('base_url')?><!--/index.php?ctl=Seller_Shop_Settled&met=index&op=step4&rp=step4&apply=--><?//=$apply?><!--&type=on" class="btn bbc_btns">上一步</a>-->
        &nbsp;&nbsp;&nbsp;
        <a id="btn_apply_company_next" class="btn bbc_btns" href="javascript:void(0);">提交</a></div>
    </form>
</div>
</div>
     <?php } ?>
