...
<div class="breadcrumb"><span class="icon-home iconfont icon-tabhome"></span><span><a href="index.php?ctl=index">首页</a></span> <span class="arrow iconfont icon-btnrightarrow"></span> <span>个人入驻申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>个人入驻申请</h3>
...
<form id="form_company_info" method="post">
    ...
    <div class="next"><a href="<?= YLB_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=pstep2&rp=pstep2&apply=1&type=on" class="btn bbc_btns">上一步</a>&nbsp;&nbsp;&nbsp;<a class="btn bbc_btns" id="btn_apply_company_next" href="javascript:;">下一步，填写入驻预经营信息</a></div>
</form>    
</div>
  </div>
</div>
