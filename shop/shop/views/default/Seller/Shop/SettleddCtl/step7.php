...
<style>
    ...
    .table_category th:nth-child(1){
        width: 15%;
    }
    .table_category th:nth-child(2){
        width: 25%;
    }
    .table_category th:nth-child(3){
        width: 25%;
    }
    .table_category th:nth-child(4){
        width: 25%;
    }
    .table_category th:nth-child(5){
        width: 10%
    }
</style>
...
<div class="main">
        ...
        <dd>
          <ul>
            ...
            <li class=""><i></i>店铺经营信息</li>
             <li class="bbc_bg_col"><i></i>店铺经营类目信息</li>
          </ul>
        </dd>
      </dl>
      <dl>
  ...
  <div class="right-layout">
    ...
    <fieldset>
        ...
        <dl>
            <dt style="margin-left: -80px;">经营类目：</dt>
            <dd>
...
<!--            <input type="hidden" name="shop_company_class" value="7">-->
    ...
    <div class="next"><a href="<?= YLB_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=step4&rp=step4&apply=<?=$apply?>" class="btn bbc_btns">上一步</a>&nbsp;&nbsp;&nbsp;<a id="btn_apply_company_next" class="btn bbc_btns" href="javascript:void(0);">提交申请</a></div>
</form>
