...
<div class="main"></div>
  ...
  <div class="right-layout">
    <div class="w fn-clear">
      <div class="joinin-step">
        <ul>
            ...
            <?php if($shop_company1['shop_status']==6&&$shop_company1['shop_payment']==7){ ?>
                <li class="step6 current"><span>店铺开通</span></li>
            <?php }else{ ?>
            <li class="step6"><span>店铺开通</span></li>
            <?php } ?>
        </ul>
      </div>
     <?php if($shop_company1['shop_status']==1 || $shop_company1['shop_status']==6 && $shop_company1['shop_payment']==0 ){?>
        <div class="content" style="text-align: center;">
           <div class="tips"><i></i><p>已经提交，请等待管理员核对后为您开通店铺</p></div>
        </div>
     <?php }elseif($shop_company1['shop_status']==7&&$shop_company1['shop_payment']==1){ ?>
         <div class="content" style="text-align: center;">0

             <div class="tips"><i></i><p>已经提交，请等待管理员核对后为您开通店铺</p></div>
         </div>
     <?php }elseif($shop_company1['shop_status']==3&&$shop_company1['shop_payment']==1 &&$shop_company1['bc_shop_status']==5){ ?>
         <div class="content" style="text-align: center;">
             <div class="tips"><i></i><p>恭喜您开店成功！</p></div>
         </div>
     <?php }else{ ?>
    ...
    <table cellpadding="0" cellspacing="1" width="100%">
        <tbody>
          <?php if(!empty($shop_company1['shop_grade'])){ foreach ($shop_company1['shop_grade'] as $keys=>$val){ ?>
         <tr>
            <td width="70">收费标准：</td>
            <td><?=$val['shop_grade_fee']?>元/年</td>
            <td width="80">开店时长：</td>
            <td><?= $shop_company1['joinin_year']?>年</td>
        </tr>
            <?php foreach ($shop_company1['shop_class'] as $keyss=>$vals){ ?>
        <tr>
            <td>店铺分类：</td>
        ...
        <tr>
            <td>应付金额：</td>
            <td colspan="3"><?=$val['shop_grade_fee']*$shop_company1['joinin_year']+$vals['shop_class_deposit'] ?>元</td>
        </tr>
          <tr>
              <td>收款方:</td>
...
<!--    <h5>经营类目列表</h5>
    ...
    <input name="shop_id" value="<?=$shop_company1['shop_id']?>" type="hidden">
    <table cellpadding="0" cellspacing="1" width="100%">
        <tbody><tr>
            <td width="70">上传凭证：</td>
            <td>
