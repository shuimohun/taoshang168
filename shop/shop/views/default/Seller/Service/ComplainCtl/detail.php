...
?>
    ...
    <div class="tabmenu">
        <ul>
            <li class="active bbc_seller_bg"><a href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Service_Complain&met=index"><?=_('投诉管理')?></a></li>
    ...
    <div class="ncsc-flow-layout">
        ...
        <div id="saleRefundReturn">
            ...
            <div class="ncsc-form-default">
                ...
                <dl>
                    <dt><?=_('商品名称：')?></dt>
                    <dd><a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $data['good']['goods_id'] ?>" target="_blank"><?= $data['good']['goods_name'] ?></a></dd>
                </dl>
                <dl>
                    <dt><?=_('订单编号：')?></dt>
                    <dd><a href="<?= YLB_Registry::get('url') ?>?ctl=Buyer_Order&met=physical&act=details&order_id=<?= $data['order_id'] ?>" target="_blank"><?= $data['order_id'] ?></a></dd>
                </dl>
                <dl>
                    <dt><?=_('投诉人：')?></dt>
