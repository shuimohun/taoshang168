...
<div class="tabmenu">
    <ul>
        ...
        } ?>><a href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Service_Consult&met=index"><?=_('全部咨询')?></a></li>
        <li <?php if ($data['state'] == 1)
        {
            echo 'class="active bbc_seller_bg"';
        } ?>><a href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Service_Consult&met=index&status=1"><?=_('未回复咨询')?></a></li>
        <li <?php if ($data['state'] == 2)
        {
            echo 'class="active bbc_seller_bg"';
        } ?>><a href="<?= YLB_Registry::get('url') ?>?ctl=Seller_Service_Consult&met=index&status=2"><?=_('已回复咨询')?></a></li>
    </ul>
</div>
        ...
        foreach ($data['items'] as $key => $value)
        {
            ...
            <tr>
                <td class="tl" colspan="2">
                    ...
                    <a target="_blank"
                       href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $value['goods_id'] ?>"><?= $value['goods_name'] ?> </a>
                </td>
            </tr>
            <tr>
