...
?>
    ...
    <div class="search fn-clear">
        <a class="button refresh" href="?ctl=Seller_Album&met=index"><i class="iconfont icon-huanyipi"></i></a>
        <a class="button btn_search_goods" href="javascript:void(0);"><i class="iconfont icon-btnsearch"></i>搜索</a>
        <input class="text w150" type="text" name="search_key" value="" placeholder="请输入名称">
    </div>
    ...
    <a href="?ctl=Seller_Album&met=index&typ=e&type=recycle" id="upload-image1" class="ui-btn ui-btn-success bbc_seller_btns"><i class="iconfont icon-lajitong icon_size20"></i>回收站</a>
    <div class="page-showcase-attachment clearfix">
        ...
        <div class="category-container">
            <div>
                ...
                <div class="ui-pagination page" id="paginationA">
                </div>
            </div>
        </div>
    ...
    <div class="action-bar clearfix">
        ...
        <a href="javascript:;" id="bulk-edit" class="batch-opt c-gray" style="cursor: not-allowed;">
            <i class="iconfont icon-zhifutijiao f18 rel_top1"></i>修改分组
        </a><span>|</span>
        <a href="javascript:;" id="bulk-remove" class="batch-opt c-gray" style="cursor: not-allowed;">
            <i class="iconfont icon-lajitong rel_top1"></i>删除
        </a>
