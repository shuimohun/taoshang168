...
?>
    ...
    <a href="?ctl=Seller_Album&met=index&typ=e" id="upload-image" class="ui-btn ui-btn-success bbc_seller_btns"><i class="iconfont icon-huanyuan icon_size20"></i>返回图片空间</a>
    ...
    <div class="action-bar clearfix">
        ...
        <a href="javascript:;" id="bulk-return" class="batch-opt c-gray" style="cursor: not-allowed;" >
            <i class="iconfont icon-huanyuan f18 rel_top1"></i>还原
        </a><span>|</span>
    ...
    <script type="text/javascript" src="<?= $this->view->js ?>/image_space_recycle.js"></script>
