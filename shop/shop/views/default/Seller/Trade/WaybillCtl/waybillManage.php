            ...
            <tr class="bd-line">
                ...
                <td class="nscs-table-handle">
                    <span data-user_express_id = "<?php echo $val['user_express_id']; ?>" data-action="choose_tpl">
                        <a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=waybillBind&typ=e&user_express_id=' .  $val['user_express_id'] . '&express_id=' . $val['express_id']; ?>"class="btn-bluejeans">
                ...
                <span data-action="set_tpl" >
                    <a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=waybillSetting&typ=e&waybill_tpl_id=' .  $val['way_bill']['waybill_tpl_id'] . '&user_express_id=' . $val['user_express_id']; ?>"class="btn-bluejeans">
