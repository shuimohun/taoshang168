    ...
    <form method = "post" id = "form">
        <table class = "table-list-style" width = "100%" cellpadding = "0" cellspacing = "0">
            ...
            <tr class = "bd-line">
                ...
                <td class="nscs-table-handle"><span><a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=designTpl&typ=e&waybill_tpl_id=' . $val['waybill_tpl_id']; ?>"
                                                       class="btn-bittersweet"><i class="iconfont icon-banshou"></i>
                    <p>设计</p>
                    </a></span><span><a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=testTpl&typ=e&waybill_tpl_id=' . $val['waybill_tpl_id']; ?>"
                                        class="btn-aqua"
                                        target="_blank"><i class="iconfont icon-icontianping"></i>
                    <p>测试</p>
                    </a></span><span><a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=editTpl&typ=e&waybill_tpl_id=' . $val['waybill_tpl_id']; ?>"
