    ...
    <form method="post" id="form" class="nice-validator n-yellow" novalidate="novalidate">
        ...
        <dl>
            ...
            <dd>
                ...
                <div id="btn_upload_img" style="width: 200px;"><i class="iconfont icon-tupianshangchuan"></i>上传图片</div>
    ...
    $(function () {
        ...
        $('#form').validator({
            ...
            fields: {
                ...
                'waybill_width':'required;integer[+];range[1~9999];',
                'waybill_height': 'required;integer[+];range[1~9999];',
                'waybill_top':'required;integer[+];range[1~9999];',
                'waybill_left': 'required;integer[+];range[1~9999];',
