...
<div class="form-style form-style_reset">
    <form method="post" id="form" class="nice-validator n-yellow" novalidate="novalidate">
        <dl>
            <dt><i class="required">*</i>显示项目：</dt>
            <dd>
                <ul id="waybill_item_list" class="ncsc-form-checkbox-list">
                    <li>
                        <input id="check_buyer_name" class="checkbox" type="checkbox" name="waybill_data[buyer_name][check]" data-waybill-name="buyer_name" data-waybill-text="收货人">
                        <label for="check_buyer_name" class="label">收货人</label>
                        <i nctype="btn_item_edit" data-item-name="buyer_name" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[buyer_name][name]" value="收货人">
                    </li>
                    <li>
                        <input id="check_buyer_area" class="checkbox" type="checkbox" name="waybill_data[buyer_area][check]" data-waybill-name="buyer_area" data-waybill-text="收货人地区">
                        <label for="check_buyer_area" class="label">收货人地区</label>
                        <i nctype="btn_item_edit" data-item-name="buyer_area" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[buyer_area][name]" value="收货人地区">
                    </li>
                    <li>
                        <input id="check_buyer_address" class="checkbox" type="checkbox" name="waybill_data[buyer_address][check]" data-waybill-name="buyer_address" data-waybill-text="收货人地址">
                        <label for="check_buyer_address" class="label">收货人地址</label>
                        <i nctype="btn_item_edit" data-item-name="buyer_address" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[buyer_address][name]" value="收货人地址">
                    </li>
                    <li>
                        <input id="check_buyer_mobile" class="checkbox" type="checkbox" name="waybill_data[buyer_mobile][check]" data-waybill-name="buyer_mobile" data-waybill-text="收货人手机">
                        <label for="check_buyer_mobile" class="label">收货人手机</label>
                        <i nctype="btn_item_edit" data-item-name="buyer_mobile" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[buyer_mobile][name]" value="收货人手机">
                    </li>
                    <li>
                        <input id="check_buyer_phone" class="checkbox" type="checkbox" name="waybill_data[buyer_phone][check]" data-waybill-name="buyer_phone" data-waybill-text="收货人电话">
                        <label for="check_buyer_phone" class="label">收货人电话</label>
                        <i nctype="btn_item_edit" data-item-name="buyer_phone" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[buyer_phone][name]" value="收货人电话">
                    </li>
                    <li>
                        <input id="check_seller_name" class="checkbox" type="checkbox" name="waybill_data[seller_name][check]" data-waybill-name="seller_name" data-waybill-text="发货人">
                        <label for="check_seller_name" class="label">发货人</label>
                        <i nctype="btn_item_edit" data-item-name="seller_name" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[seller_name][name]" value="发货人">
                    </li>
                    <li>
                        <input id="check_seller_area" class="checkbox" type="checkbox" name="waybill_data[seller_area][check]" data-waybill-name="seller_area" data-waybill-text="发货人地区">
                        <label for="check_seller_area" class="label">发货人地区</label>
                        <i nctype="btn_item_edit" data-item-name="seller_area" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[seller_area][name]" value="发货人地区">
                    </li>
                    <li>
                        <input id="check_seller_address" class="checkbox" type="checkbox" name="waybill_data[seller_address][check]" data-waybill-name="seller_address" data-waybill-text="发货人地址">
                        <label for="check_seller_address" class="label">发货人地址</label>
                        <i nctype="btn_item_edit" data-item-name="seller_address" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[seller_address][name]" value="发货人地址">
                    </li>
                    <li>
                        <input id="check_seller_phone" class="checkbox" type="checkbox" name="waybill_data[seller_phone][check]" data-waybill-name="seller_phone" data-waybill-text="发货人电话">
                        <label for="check_seller_phone" class="label">发货人电话</label>
                        <i nctype="btn_item_edit" data-item-name="seller_phone" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[seller_phone][name]" value="发货人电话">
                    </li>
                    <li>
                        <input id="check_seller_company" class="checkbox" type="checkbox" name="waybill_data[seller_company][check]" data-waybill-name="seller_company" data-waybill-text="发货人公司">
                        <label for="check_seller_company" class="label">发货人公司</label>
                        <i nctype="btn_item_edit" data-item-name="seller_company" title="微调" class="iconfont icon-edit"></i>
                        ...
                        <input id="" type="hidden" name="waybill_data[seller_company][name]" value="发货人公司">
                    </li>
                </ul>
        ...
        <div class="bottom">
            <label class="submit-border">
                <input id="submit" type="button" class="submit bbc_seller_btns" value="提交">
