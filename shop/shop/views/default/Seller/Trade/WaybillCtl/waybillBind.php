    ...
    <table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr class="bd-line">
            ...
            <td class="nscs-table-handle">
                <span>
                    <a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=testTpl&typ=e&waybill_tpl_id=' . $val['waybill_tpl_id']; ?>" class="btn-aqua" target="_blank">
            ...
            <tr>
                <td colspan="20" class="norecord">
                    <!-- <div class="warning-option">
                        <i class="icon-warning-sign"></i><span style="color: #27A9E3;">还没有可用的运单模板，<a href="<?php echo YLB_Registry::get('url') . '?ctl=Seller_Trade_Waybill&met=waybillIndex&typ=e'; ?>">去建立模板</a></span>
                    </div> -->
