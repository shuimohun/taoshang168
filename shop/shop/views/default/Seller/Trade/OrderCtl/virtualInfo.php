    ...
    <div class="ncsc-order-info">
        ...
        <div class="ncsc-order-condition">
            <!--<dl>
                ...
                <dd><?php /*echo $order_data['order_status_text']; */?></dd>
            </dl>-->
        </div>
    </div>
    ...
    <div class="ncsc-order-contnet">
        <table class="ncsc-default-table order">
            ...
            <tr>
                ...
                <td>
                    <div class="pic-thumb">
                        <a target="_blank" href="<?php echo YLB_Registry::get('url') . '?ctl=Goods_Goods&met=goods&type=goods&gid=' . $goods_list['goods_id']; ?>" target="_blank"><img width="60px" height="60px" src="<?php echo $goods_list['goods_image']; ?>"></a>
                    </div>
                </td>
                <td class="tl">
                    <dl class="goods-name">
                        <dt>
                            <a target="_blank" href="<?php echo YLB_Registry::get('url') . '?ctl=Goods_Goods&met=goods&type=goods&gid=' . $goods_list['goods_id']; ?>" target="_blank" style="color: #666;" title="<?php echo $goods_list['goods_name']; ?>"><?php echo $goods_list['goods_name']; ?></a>
                            <a target="_blank" href="<?php echo YLB_Registry::get('url') . '?ctl=Goods_Goods&met=goods&type=goods&gid=' . $goods_list['goods_id']; ?>" class="blue ml5">[交易快照]</a>
                        </dt>
                        <dd>
                ...
                <td class="bdl border-right1"><?php echo $order_data['order_status_const']; ?></td>
            </tr>
            </tbody>
            <tfoot>
            <tr>
...
//    $($('.tabmenu > ul')[0]).find('li:lt(6)').remove();
    ...
    $('#codeList').children("ul").append('<?php foreach($code_data as $v){echo '<li class=""><strong>'.$v["virtual_code_id"].'</strong>未使用，有效期至 '.$order_data['common_virtual_date'].'</li>';}?>');
    ...
    $('#codeList').children("ul").append('<?php foreach($code_data as $v){echo '<li class=""><strong>'.$v["virtual_code_id"].'</strong>已使用，</li>';}?>');
