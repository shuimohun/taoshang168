    ...
    <table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
		<tbody>
			...
			<tr>
				...
				<!--- 操作 --->
				<td>
					<span class="edit"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Trade_Deliver&met=addAddress&op=edit&shipping_address_id=<?=($val['shipping_address_id'])?>"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
