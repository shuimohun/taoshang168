...
<div class="exchange">
	...
	<div class="search fn-clear">
        <form id="search_form" method="get" action="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=index&typ=e">
            ...
            <a class="button refresh" href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=index&typ=e"><i class="iconfont icon-huanyipi"></i></a>
        ...
        <?php if($data['items']) { foreach($data['items'] as $key=>$value) { ?>
            <tr class="row_line">
                ...
                <td class="nscs-table-handle">
                    <span class="edit"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=add&op=edit&typ=e&id=<?=$value['discount_id']?>"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
                    <span class="edit del_line"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=index&op=manage&typ=e&id=<?=$value['discount_id']?>"><i class="iconfont icon-setting"></i><?=_('管理')?></a></span>
