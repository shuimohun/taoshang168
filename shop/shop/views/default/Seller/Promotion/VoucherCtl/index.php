...
<div class="exchange">
    ...
    <div class="fn-clear" style="padding:10px 0 10px;">
        <form method="get" id="search_form" action="index.php" >
            ...
            <label class="search" >&nbsp;&nbsp;
                <a class="button refresh" href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Voucher&met=index&typ=e"><i class="iconfont icon-huanyipi"></i></a>
            ...
            <tr class="row_line">
                ...
                <td class="nscs-table-handle">
                    <?php if($value['voucher_t_state'] === Voucher_TempModel::VALID){ ?>
                        <span class="edit"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Voucher&met=add&op=edit&id=<?=$value['voucher_t_id']?>&typ=e"><i class="iconfont icon-zhifutijiao"></i><?=_('编辑')?></a></span>
                    <?php } ?>
                    <span class="edit"><a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Promotion_Voucher&met=index&op=detail&id=<?=$value['voucher_t_id']?>&typ=e"><i class="iconfont icon-btnclassify2"></i><?=_('详情')?></a></span>
