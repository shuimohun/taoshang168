...
?>
    <script type='text/jade' id='thrid_opt'>
        <a class="bbc_seller_btns button add button_blue" href="<?= YLB_Registry::get('index_page') ?>?ctl=Seller_Goods&met=addFormat&typ=e&act=add"><i class="iconfont icon-jia"></i>添加新版式</a>
    </script>
    <script type="text/javascript">
        $(function (){
            $('.tabmenu ul li:eq(1)').remove();
    ...
    <div class="search fn-clear">
        ...
        <form id="search_form" class="search_form_reset" method="get" action="<?= YLB_Registry::get('url') ?>">
            <input class="text w150" type="text" name="search_key" value="" placeholder="请输入版式名称"/>
            ...
            foreach ($data as $key => $value)
            {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="edit"><a
                                href="<?php echo YLB_Registry::get('url'); ?>?ctl=Seller_Goods&met=addFormat&act=edit&id=<?= $value['id']; ?>"><i
