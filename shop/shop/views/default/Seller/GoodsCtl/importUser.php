    ...
    <div class="mod-inner"  style="width:480px; ">
        ...
        <div id="import-wrap" class="cf">
            <div id="import-step1" class="step-item">
                ...
                <p><a href="#" class="link">下载导入模板</a></p>
                <div class="step-btns">
...
<script type="text/javascript">
    (function (){
        ...
        var uploadInstance = WebUploader.create({
            ...
            swf: '<?=YLB_Registry::get('base_url')?>' + '/shop/static/common/js/Uploader.swf',
        ...
        function uploadSuccess(data){
            importDialog = parent.$.dialog.tips('正在导入，请耐心等待...',1000,'loading.gif',true).show();
            $.post( SITE_URL + "?ctl=Seller_Goods&met=importUser&typ=json", {'url_path': data.url_path},
                function ( data ) {
                    importDialog.close();
