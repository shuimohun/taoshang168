...
?>
        ...
        <style>
            ...
            /*<img src="455718953-1.jpg" alt="id=" /><br />
            <img src="455718953-2.jpg" alt="id=" /><br />
            <img src="455718953-3.jpg" alt="id=" /><br />
            <img src="455718953-4.jpg" alt="id=" /><br />
            <img src="455718953-5.jpg" alt="id=" /><br />
            <img src="455718953-6.jpg" alt="id=" /><br />
            <img src="455718953-7.jpg" alt="id=" /><br />
            <img src="455718953-8.jpg" alt="id=" /><br />
            <img src="455718953-9.jpg" alt="id=" /><br />
            <img src="455718953-10.jpg" alt="id=" /><br />
            <img src="455718953-11.jpg" alt="id=" /><br />
            <img src="455718953-12.jpg" alt="id=" /><br />
            <img src="455718953-13.jpg" alt="id=" /><br />*/

            #uploader .finshed-basic{width:950px;height:64px;}
            #uploader .finshed{height: 64px;line-height: 64px;background-color: #fff;padding-top:0;}
            #uploader .finshed.fixed .finshed-1200{width:1200px;height:64px;margin:0 auto;}
            #uploader .finshed.fixed .finshed-950{width:950px;border-right:1px solid #dadada;border-left:1px solid #dadada;height:64px;float: right;margin-right:14px;}
        </style>
        <link href="<?=$this->view->css_com?>/webuploader.css" rel="stylesheet">
        <script src="<?=$this->view->js_com?>/webuploader.js"></script>
        <script src="<?=$this->view->js?>/taobao_import_image_detail.js"></script>
        ...
        <ol class="step fn-clear add-goods-step clearfix">
            <li style="width:32%;">
                ...
                <a href="<?=YLB_Registry::get('url')?>?ctl=Seller_Goods_TBImport&met=importFile&typ=e"><h2>第一步：导入CSV文件</h2></a>
            ...
            <li style="width:32%;">
                ...
                <h2 class="bbc_seller_color">第三步：上传详情图</h2>
            </li>
        </ol>
                ...
                <div id="uploader">
                    <div class="queueList">
                        <div id="dndArea" class="placeholder">
                            ...
                            <p class="f14">或将照片拖到这里，单次最多可选300张</p>
                        </div>
