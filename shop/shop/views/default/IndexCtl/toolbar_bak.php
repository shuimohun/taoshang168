    ...
    <div class="toolbar">
        <div class="toolbar-panels J-panel">
            ...
            <div style="visibility: hidden;" class="J-content toolbar-panel tbar-panel-cart toolbar-animate-out">
                ...
                <?php  if(isset($cart_list) && $cart_list['count']) :?>
                    <div class="tbar-panel-main tbar-panel-main-sidebar cart_con">
                        <?php foreach($cart_list['cart_list'] as $cartk => $cartv): ?>
                    ...
                    <div class="cart_pay">
                        <div class="padd">
                            <div class="cart_foot clearfix">
                                <span class="cartall"><?='总计:'?><?=format_money($cart_list['sum'])?></span>
                            </div>
                            <div class="topay">
                                        ...
                                        <?php if(!empty($v['detail']['items'])){?>
                                            <?php foreach($v['detail']['items'] as $kk=>$vv){ ?>
                                                <a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$vv['goods_id']?>">
                                                    ...
                                                    <div class="share_div_gz">
                                                        <p class="share_wrap_gz">
                            <span class="share_gz">分享立减
                                <u><?=format_money($vv['goods_share_price'])?></u>
                            </span>
                                                        </p>
                                                        <p class="share_wrap_gz">
                            <span class="share_gz">分享立赚
                                <u><?=format_money($vv['goods_promotion_price'])?></u>
                            </span>
                                                        </p>
                                                        <p class="clear"></p>
                                                    </div>
                                ...
                                <?php if(!empty($v['detail'])){?>
                                    <li>
                                        <a href="<?=YLB_Registry::get('url')?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$v['detail']['goods_id']?>">
                                            ...
                                            <div class="share_div_zj">
                                                <p class="share_wrap_zj">
                            <span class="share_zj">分享立减
                                <u><?=format_money($vv['goods_share_price'])?></u>
                            </span>
                                                </p>
                                                <p class="share_wrap_sc">
                            <span class="share_zj">分享立赚
                                <u><?=format_money($vv['goods_promotion_price'])?></u>
                            </span>
                                                </p>
                                                <p class="clear"></p>
                                ...
                                <?php if(!empty($v['detail'])){?>
                                    <li>
                                        <a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$v['goods_id']?>">
                                            ...
                                            <div class="share_div_sc">
                                                <p class="share_wrap_sc">
                            <span class="share_sc">分享立减
                                <u><?=format_money($vv['goods_share_price'])?></u>
                            </span>
                                                </p>
                                                <p class="share_wrap_sc">
                            <span class="share_sc">分享立赚
                                <u><?=format_money($vv['goods_promotion_price'])?></u>
                            </span>
                                                </p>
                                                <p class="clear"></p>
        ...
        <div class="toolbar-tabs J-tab">
            ...
            <div class=" toolbar-tab  tbar-tab-cart shopcli" data-type="cart">
                ...
                <span class="tab-sub J-count"><?php if(isset($cart_list) && $cart_list['count']){echo $cart_list['count']; }else{ echo '0';}?></span>
            </div>
