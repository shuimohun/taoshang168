...
<script>
	...
	window.domain_root = "http://www.taoshang168.com/demo1/";
...
<div id="navbar" class="navbar navbar-inverse navbar-fixed-top" style="display:none;">
	<div class="navbar-inner">
		<div class="container">
                    ...
                    padding-top: 10px;padding-right: 0px;padding-bottom: 10px;padding-left: 0px;text-shadow: 0px 0px 0px;color:#eee"></span>
...
<input type="hidden" name="ucenter_url" class="ucenter_url" value="<?/*= YLB_Registry::get('ucenter_api_url') */?>">
<input type="hidden" name="imbuilder_url" class="imbuilder_url" value="<?/*= YLB_Registry::get('im_api_url') */?>">-->