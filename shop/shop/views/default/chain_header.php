...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="shortcut icon" href="http://www.taoshang168.com/shop/favicon.ico" type="image/x-icon">
            ...
            foreach ($chain_menu as $menu_row)
            {
                ...
                <li class="<?= ($menu_row['menu_id'] == $level_row[1]) ? 'cur bbc_seller_bg' : '' ?>">
                    <a class="dropdown-toggle"
                       href="<?= sprintf('%s?ctl=%s&met=%s&typ=e&%s', YLB_Registry::get('url'), $menu_row['menu_url_ctl'], $menu_row['menu_url_met'], $menu_row['menu_url_parem']); ?>">
