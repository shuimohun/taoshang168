                                ...
                                <div class="title">
                                    ...
                                    <?php
                                        ...
                                        if($order_detai['payment_id']==$paymentChannlModel::PAY_CHAINPYA){?>
                                            <div class="no-pay"><i class="icon-quote-left">[</i>该笔尚未付款，需支付<strong><?=$order_detai['order_payment_amount']?>元</strong>,门店收款后再进行提货验证。<i class="icon-quote-right">]</i> </div>
                                        <?php }?>
                                </div>
                                <label>
                                    <input class="text w200 vm" type="text" maxlength="6" name="pickup_code" placeholder="请输入买家提供的验证码" autocomplete="off">
                                    <span></span>
                                    <input type="submit" class="button bbc_seller_submit_btns" value="提交">
                                </label>
                                <p>该验证码为商城订单生成时，自动发送给收货人手机及买家订单详情中的提供的“4位验证码”。</p>
                            </div>
