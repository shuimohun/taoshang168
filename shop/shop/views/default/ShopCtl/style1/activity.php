...
?>
    ...
    <div ng-app="app" ng-controller="shopActivityCtl">
                                        ...
                                        <div class="ncp-voucher goStore">
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="point">
                                                    ...
                                                    <p>
                                                        <em class="giveout" ng-bind="item.voucher_t_giveout"></em> 人兑换
                                                    </p>
                                                </div>
                                                ...
                                                <div class="time-wrap mt-11">
                                                    ...
                                                    <span class="time">{{item.voucher_t_end_date_day}}</span>
                                                </div>
                                                <div class="btn-right">
                                                    <a href="javascript:void(0);" ng-click="receiveVoucher(item.id)"  ng-if="item.voucher_t_access_method==1">立即兑换</a>
                                                    <a href="javascript:void(0);" ng-click="receiveVoucher(item.id)"  ng-if="item.voucher_t_access_method!=1">免费兑换</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="sale-buy-item lf" ng-repeat="item in scareList">
                                    <div class="time-wrap">
                                        <div class="time">
                                            ...
                                            <div class="fnTimeCountDown lf" data-end="{{item.scarebuy_endtime}}" >
                                    ...
                                    <div class="time-bottom orflow">
                                        ...
                                        <div class="img-else lf">
                                            ...
                                            <div class="price-wrap">
                                                <span class="new-price">￥<em ng-bind="item.scarebuy_price"></em></span>
                                            ...
                                            <div class="share-wrap clearfix">
                                                <div class="share lf share-province">             <!--share-province  分享立省-->
                                                    <span class="icon"></span>
                                                    <span class="save">分享立省{{item.share_ls}}</span>
                                                </div>
                                            </div>
                                            <div class="share-wrap clearfix">
                                                <div class="share lf to-earn">             <!--to-earn  再赚-->
                                                    <span class="icon"></span>
                                                    <span class="save">再赚{{item.share_lz}}</span>
                                                </div>
                                            </div>
                                            <div class="qiang">
                                                <div class="qiang-left">
                                                    ...
                                                    <div class="progress">
                                                        <img src="<?=$this->view->img?>/rectangle@3x.png" alt="" width="0%">
                                                    </div>
                                                </div>
                                ...
                                <li class="discount-item lf" ng-repeat="item in discountList">
                                    ...
                                    <div class="img-else lf">
                                        ...
                                        <div class="price-wrap">
                                            ...
                                            <span class="discount-price">折扣价:<i ng-bind="item.discount_price"></i></span>
                                        </div>
                                        <div class="progress">
                                            <img src="<?=$this->view->img?>/rectangle@3x.png" alt="" >
                                        </div>
                                        <div class="sheng">
                        ...
                        <div class="full-delivery-content">
                            <ul class="orflow li-5-list">
                                ...
                                <li class="lf li-5-item" ng-repeat="item in mansongList['rule']">
                                    <div class="item-top">
                                        <div class="img-center">
                                            <a href="javascript:void(0);" ng-if="item.goods_image!=''||item.goods_image!=0">
                                                <img ng-src="{{item.goods_image}}" ng-click="goodsInfo(item.goods_id,'gid')" alt="">
                                            </a>
                                            <a href="javascript:void(0);" ng-if="item.goods_image==''||item.goods_image==0">
