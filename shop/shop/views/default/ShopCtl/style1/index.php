...
<style>
    .full-screen-slides-pagination{display:none !important;}
    ...
    .share_wrap{display:inline-block;float:left;margin-left:10px;margin-top:0px;margin-bottom:-3px}
    .share u{text-decoration:none;background-color:#c51e1e;color:#fff;float:right;width:48px;height:100%;text-align:center}
    .share_cart{border:1px solid#c51e1e;font-size:12px;color:#c51e1e;float:left;margin-left:3px;margin-top:3px}
            ...
            <div class="ncsl-nav">
                ...
                <?php if(!empty($decoration_detail['decoration_nav']) || $decoration_detail['decoration_nav']['display'] == 'true') {?>
                    <div id="nav" class="ncs-nav">
                        <ul>
                            <li class="active9"><a href="index.php?ctl=Shop&met=index&id=<?=$shop_id?>"><span>店铺首页<i></i></span></a></li><!-- 模板二当前页面的li需添加class为actives，例：<li class="active9 actives"> -->
...
<div class="template-bg"> <!-- 模板二大背景色 -->
    <div class="wrap clearfix template-gray">
        ...
        <div id="nav" class="bbc-nav">
            <ul>
                <li class="active9"><a href="index.php?ctl=Shop&id=<?=$shop_id?>"><span>店铺首页<i></i></span></a></li><!-- 模板二当前页面的li需添加class为actives，例：<li class="active9 actives"> -->
                <li class="active9"><a href="index.php?ctl=Shop&met=activity&id=<?=$shop_id?>"><span>优惠活动<i></i></span></a></li>
                <?php if($shop_nav['items']){ foreach ($shop_nav['items'] as $key => $value) {?>
                    <li><a href="<?php if(!empty($value['url'])) echo $value['url'];else echo 'index.php?ctl=Shop&met=info&id='.$shop_id.'&nav_id='.$value['id']; ?>" <?php if($value['target']){?>target="_blank" <?php } ?>><span><?=$value['title']?><i></i></span></a></li>
                <?php }} ?>
        ...
        <div class="t_goods_bot clearfix">
                    ...
                    <div class="current_hot">
                        ...
                        <ul>
                            <?php  foreach ($data_hot as $key_hot => $value_hot):  ?>
                                <li>
                                    <a href="./index.php?ctl=Goods_Goods&met=goods&gid=<?= $value_hot['goods_id'] ?>">
                                    ...
                                    <div class="current_hot__look clearfix"> <a class="bbc_btns" href="./index.php?ctl=Goods_Goods&met=goods&gid=<?= $value_hot['goods_id'] ?>">去看看</a>
                                    </div>
                                </li>
                            <?php  endforeach; ?>
                        </ul>
            ...
            <div class="t_goods_bot_right-1">
                                ...
                                foreach ($goods_recom_list['items'] as $key => $value) {
                                    ...
                                    <li>
                                        <dl>
                                            ...
                                            <dd class="goods-info"><span class="priceSS bbc_color"><?=format_money($value['common_price']) ?></span> <span class="goods-sold">已售：<strong><?=$value['common_salenum']?></strong> 件</span>
                                            </dd>
                ...
                <div class="bbc-main-container" style="clear:both">
                    <div class="title"><span><a href="index.php?ctl=Shop&met=goodsList&id=<?=$shop_id?>" class="more">更多<span class="iconfont icon-iconjiantouyou rel_top-3"></span></a></span>
                        <h4>新品</h4>
                    </div>
                    <div class="content_s bbc-goods-list">
                ...
                <div class="bbc-main-container" style="clear:both">
                    ...
                    <div class="content_s bbc-goods-list">
                        <ul>
                            <?php foreach ($shop_goods_like as $key => $value) {?>
                                    <li>
                                        <dl>
                                            <dt><a href="index.php?ctl=Goods_Goods&met=goods&cid=<?=$value['common_id']?>" class="goods-thumb" target="_blank"><img  src="<?=image_thumb($value['common_image'],220,220)?>" alt="<?=$value['common_name']?>"></a>
                                            <ul class="goods-thumb-scroll-show">
                                                <li class="selectedSS"><a href="javascript:void(0);"><img width="60" src="<?=$value['common_image']?>"></a></li>
                                            </ul>
                                            </dt>
                                            <dd class="goods-name"><a href="index.php?ctl=Goods_Goods&met=goods&cid=<?=$value['common_id']?>" title="<?=$value['common_name']?>" target="_blank"><?=$value['common_name']?></a></dd>
                                            <dd class="goods-info"><span class="priceSS bbc_color"><?=format_money($value['common_price']) ?></span> <span class="goods-sold">已售：<strong><?=$value['common_salenum']?></strong> 件</span></dd>
