            ...
            <div class="rightcont">
                ...
                <div class="ncg-screen">
                    ...
                    { ?>
                        <dl>
                            <dt><?=_('状态')?>：</dt>
                            <dd class="<?=(request_string('state')!='underway' && request_string('state')!='history') ? 'hova' : ''?>"><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList"><?=_('正在进行')?></a></dd>
                            <dd class="<?=request_string('state')=='underway'?'hova':''?>"><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList&state=underway" ><?=_('即将开始')?></a></dd>
                            <dd class="<?=request_string('state')=='history'?'hova':''?>"><a href="<?=YLB_Registry::get('url')?>?ctl=GroupBuy&met=vrGroupBuyList&state=history" ><?=_('已经结束')?></a></dd>
                        </dl>
                            ...
                            foreach ($data['groupbuy_goods']['items'] as $key => $groupbuy_goods)
                        {
                            ...
                            <li class="online">
                                <div class="ncg-list-content">
                                    <a title="<?= $groupbuy_goods['goods_name'] ?>" href="<?= YLB_Registry::get('url') ?>?ctl=GroupBuy&met=detail&id=<?= $groupbuy_goods['groupbuy_id'] ?>" class="pic-thumb"
                                       target="_blank">
