    ...
    <div class="root61">
        <div class="l-nav">
            <div class="w">
                <ul class="b-nav-list">
                    <li class="li-item">
                        <a href="index.php?ctl=Rule&met=index" clstag="pageclick|keycount|rule_home|2" class="link-dlk">首页</a>
                    </li>
                    <li class="li-item">
                        <a href="index.php?ctl=Rule&met=ruleOverview" clstag="pageclick|keycount|rule_home|3" class="link-dlk">规则总览</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="l-wrap">
                    ...
                    <div class="b-search-wrap">
                        <form action="" id="search-form">
                            ...
                            <div class="b-hotwords">
                                ...
                                热门搜索：<a href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&title=违规' ?>"  class="link-ib" clstag="pageclick|keycount|rule_home|7">违规</a>
                                <a href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&title=续签' ?>" class="link-ib" clstag="pageclick|keycount|rule_home|9">续签</a>
                                <a href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&title=支付' ?>" class="link-ib" clstag="pageclick|keycount|rule_home|10">支付</a>
                            </div>
                        </form>
                    </div>
                    <!-- search -->
                    <div class="mod-s01" id="id-gongao">
                        ...
                        <div class="mod-bd">
                            <ul class="normal-list" style="font-size: 14px">
                                ...
                                ?>
                                <li class="li-item"><a target="_blank" href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleDetail&id=' ?><?= ($data['help_id']) ?>" clstag="pageclick|keycount|rule_home|289">&middot;<?= ($data['help_title'])?></a>
                                </li>
                                <?php
                                endforeach;
                                ?>
            ...
            <div class="l-main">
                <div class="mod-s01 fl mod-wide" id="id-hotrule">
                    <div class="mod-hd">
                        ...
                        <div class="h-extra">
                            <ul class="normal-list-x">
                                ...
                                ?>
                                <li class="li-item"><a
                                            href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleDetail&id=' ?><?= ($data['help_id']) ?>" clstag="pageclick|keycount|rule_home|2754"><?= ($data['help_title'])?></a>
                                </li>
                                <?php
                                endforeach;
                                ?>
                    ...
                    <div class="mod-bd">
                        ...
                        <dl class="dl-list" style="margin-bottom: 15px">
                            <dt class="dl-hd"><a href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&id=' ?><?= ($data['help_group_id']) ?>"><?= ($data['help_group_title'])?></a></dt>
                            <dd class="dl-bd">
                                <ul class="normal-list">
                                    ...
                                    ?>
                                    <li class="li-item"><a href="<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&id=' ?><?= ($S['help_group_id']) ?>" clstag="pageclick|keycount|rule_home|392"><?= ($S['help_group_title'])?></a></li>
                                                <?php
                                                endif;
                                                ?>
                                    <?php
                ...
                <div class="mod-small" id="id-newrule" style="display: inline-block;height: 278px;width: 278px;background-image: url('<?= $this->view->img ?>/month-newly.jpg')">
                    <a href="index.php?ctl=Rule&met=noticeList" clstag="pageclick|keycount|rule_home|44"></a>
                </div>
                <div class="mod-small"  style="text-align: center;	display: inline-block;height: 170px;width: 278px;background-image: url('<?= $this->view->img ?>/guizegonggao.jpg')">
                    <a href="index.php?ctl=Rule&met=noticeDetail" style="	display: inline-block;font-size: 40px;padding-top: 80px;	color: #6693ff;" clstag="pageclick|keycount|rule_home|44">最新公告</a>
                </div>
                <!-- id-newrule -->
...
<script>
    ...
    $('#submit_btn').click(function () {
       var text = $(" input[ name='title' ] ").val();
        window.location.replace('<?= YLB_Registry::get('url') . '?ctl=Rule&met=ruleOverview&title=' ?>'+text);
    })
</script>
