                ...
                <?php foreach($data['items'] as $evkey=>$eval): ?>
                    ...
                    <div class="comment clearfix">
                        ...
                        <div class="detaildiv_2 ">
                            ...
                            <p><?=($evval['content'])?>
                                <span>
                                    <?php foreach($evval['image_row'] as $imgkey => $imgval): ?>
                                        <a class="banimga">
                                            <?php if($imgval): ?>
                                                <img rel="<?=image_thumb($imgval,300,300)?>" src="<?=image_thumb($imgval,100,100)?>" class="sjqzoom">
                                            <?php endif;?>
                                        </a>
                                    <?php endforeach; ?>
                                </span>
                            ...
                            <?php if(isset($eval[1])): ?><br/>
                                <p><?=_('[追加]')?><?php Text_Filter::filterWords($eval[1]['content']);?><?=($eval[1]['content'])?>
