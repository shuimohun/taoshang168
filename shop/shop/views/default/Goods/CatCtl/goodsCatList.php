                ...
                <div class="current_hot">
                    ...
                    <ul>
                        <?php if (!empty($data_recommon_goods))
                        {
                            ...
                            {
                                ?>
                                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=($value_recommon['goods_id'])?>"><img src="<?= $value_recommon['common_image'] ?>"/><h5 class="common-color">
                    ...
                    <h4><?=_('惠抢购');?></h4>
                    <ul>
                        <?php if (!empty($data_scarebuy_goods))
                        {
                            foreach ($data_scarebuy_goods as $key => $value)
                            {
                                ?>
                                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=($value['goods_id'])?>"><img src="<?= $value['goods_image'] ?>"/><h5 class="common-color">
                                            ￥<?= $value['scarebuy_price'] ?></h5></a></li>
                                <?php
                            }
                        }
                        ?>
                    </ul>
                    <div class="hot_all"><a href="<?= YLB_Registry::get('url') ?>?ctl=ScareBuy&met=index" class="bbc_bg"><?=_('全部热门惠抢购'); ?></a></div>
                </div>
            </div>
        </div>
    </div>
