...
Dialog.prototype = {
    ...
    'init'          : function(){
        ...
        /* 创建关闭按钮 */
        this.dom.close_button   = $('<span class="dialog_close_button iconfont icon-cuowu"></span>').get(0);
...
function showDialog(msg, mode, t, func, cover, funccancel, leftmsg, confirmtxt, canceltxt, closetime, locationtime) {
	...
	s += '</span><span class="dialog_close_button iconfont icon-cuowu" id="fwin_dialog_close" onclick="hideMenu(\'' + menuid + '\', \'dialog\')" title="关闭"></span></h3>';
	if(mode == 'info') {
		s += msg ? msg : '';
	} else {
