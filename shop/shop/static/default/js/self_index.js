...
$(function(){
    ucenterSelfLogin(UCENTER_URL, SITE_URL, false);
});
...
function ucenterSelfLogin(UCENTER_URL, SITE_URL, refresh_flag)
{
    $.ajax({
        type: "get",
...
function getSelfUserInfoNav()
{

    $.ajax({
        type: "GET",
        url: SITE_URL + "?ctl=Self_Index&met=getUserLoginInfo&typ=json",
        data: {},
        dataType: "json",
        success: function(data){
            var html = '';
