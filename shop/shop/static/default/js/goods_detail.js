...
$(document).ready(function(){
	...
	//商品详情 goods_detail
    load_goodseval(SITE_URL  + '?ctl=Goods_Goods&met=getGoodsDetail&common_id=' + common_id,'goods_detail');

    //评价列表
    $('#goodseval').load(SITE_URL  + '?ctl=Goods_Goods&met=getGoodsEvaluationList&common_id=' + common_id + '&type=all',function () {
        $('#goodsevals').html($('#goodseval').html())
    });
