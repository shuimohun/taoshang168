...
$(function(){
    ucenterSelfSupportLogin(UCENTER_URL, SITE_URL, false);
});
...
function ucenterSelfSupportLogin(UCENTER_URL, SITE_URL, refresh_flag)
{
    $.ajax({
        type: "get",
...
function getSelfSupportUserInfoNav()
{

    $.ajax({
        type: "GET",
        url: SITE_URL + "?ctl=SelfSupport_Index&met=getUserLoginInfo&typ=json",
        data: {},
        dataType: "json",
        success: function(data){
            var html = '';
