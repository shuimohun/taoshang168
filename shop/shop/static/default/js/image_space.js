...
$(function () {
    ...
    function initCategory() {
        ...
        $.post(SITE_URL + '?ctl=Seller_Album&met=getAlbumList&typ=json&firstRow=' + _pageA.firstRow + '&totalRows=' + _pageA.totalRows, {firstRow: _pageA.firstRow}, function (data) {
            if (data.status == 200) {
    ...
    $('.btn_search_goods').on('click',function () {
        var search_key = $.trim($('input[name="search_key"]').val());
        _page.search_key = search_key;
        initPage();
    })
