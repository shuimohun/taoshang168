...
if (RUNTIME) {
    ...
    $runtime_file = DATA_PATH . '/runtime/' . VER . '/' . $runtime . '.php';
}
...
if (RUNTIME && is_file($runtime_file)) {
    ...
    array_push($import_file_row, INI_PATH . '/config.ini.php');
...
if (RUNTIME) {
    YLB_Registry::set('runtime', $runtime);
    YLB_Registry::set('runtime_file', $runtime_file);
}
YLB_App::start();
