...
$(function ()
{
    ...
    $("#product_list").on("click", ".goods-store a", function ()
    {
        ...
        var i = $(this).text();
        $.getJSON(ApiUrl + "?act=store&op=store_credit", {shop_id: r}, function (t)
        {
...
function get_list()
{
    ...
    $.getJSON(ApiUrl + "?ctl=Goods_Goods&met=goodslist&typ=json&ua=wap&sub_site_id="+sub_site_id + window.location.search.replace("?", "&"), param, function (e)
    {
        if (!e)
        {
            e = [];
