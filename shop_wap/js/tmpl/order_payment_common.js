        ...
        success: function (p) {
            ...
            $("#toPay").click(function () {
                ...
                if (s) {
                    ...
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "?act=member_buy&op=check_pd_pwd",
                        dataType: "json",
...
function goToPayment(a, e) {
    location.href = ApiUrl + "?act=member_payment&op=" + e + "&key=" + key + "&pay_sn=" + a + "&password=" + password + "&rcb_pay=" + rcb_pay + "&pd_pay=" + pd_pay + "&payment_code=" + payment_code
}