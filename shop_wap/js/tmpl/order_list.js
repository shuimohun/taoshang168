...
$(function () {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "?ctl=Buyer_Order&met=physical&typ=json&page=" + page + "&curpage=" + curpage,
    ...
    function i(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "?ctl=Buyer_Order&met=hideOrder&typ=json",
            data: {order_id: r, k: e, u: getCookie('id'), user: 'buyer'},
            dataType: "json",
            success: function (e) {
                if (e.status == 200) {
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "?ctl=Buyer_Order&met=confirmOrder&typ=json",
