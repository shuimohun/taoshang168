$(function () {
    ...
    $.getJSON(ApiUrl + "?ctl=Buyer_Order&met=evaluation&act=add&typ=json", {k: e,u:u, order_id: a}, function (r) {
        if (r.status == 250) {
        ...
        $(".btn-l").click(function () {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "?ctl=Goods_Evaluation&met=againWapGoodsEvaluation&typ=json",
