...
$(function ()
{
    ...
    $.getJSON(ApiUrl + "?ctl=Base_District&met=district&typ=json", param, function (e)
    {
...
function get_list()
{
    ...
    if (this.near)
    {
        ...
        var url = ApiUrl + "?ctl=Shop_Index&met=near&typ=json";
    }
    else
    {
        var url = ApiUrl + "?ctl=Shop_Index&met=index&typ=json&ua=wap&sub_site_id="+sub_site_id;
    }
