$(function ()
{
    ...
    var e = getCookie("key");
    $.ajax({
        type: "post", url: ApiUrl + "?ctl=Buyer_User&met=address&act=edit&typ=json", data: {k:e,u:getCookie('id'), id: a}, dataType: "json", success: function (a)
        {
            checkLogin(a.login);
    ...
    $(".btn").click(function ()
    {
        if ($.sValid())
        {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "?ctl=Buyer_User&met=editAddressInfo&typ=json",
