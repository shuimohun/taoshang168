    ...
    $.ajax({
        ...
        success:function(result)
        {
            if(result.status == 200)
            {
                ...
                else if(!data.user_info.user_alipay)
                {
...
$('#form').validator({
    ...
    valid:function (form) {
      ...
      //提交前锁住表单
        ...
        $.ajax({
            url:ajax_url,
            data:{id:id,user_alipay:user_alipay,withdraw_money:withdraw_money,con:con,paypasswd:paypasswd,yzm:yzm,mobile:mobile,val:val},
            success:function(a)
            {
                console.info(a);
                if(a.status == 200)
