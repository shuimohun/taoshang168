            ...
            Fe = function (e) {
                ...
                return N(t, e), ze(t, [{
                    ...
                    value: function (e, t) {
                        this.setShareData(t);
                        var n = this.getShareData();
                        location.href = "baidubrowserapp://bd_utils?action=shareWebPage¶ms=" + encodeURIComponent(JSON.stringify({
                                title: n.title,
                                content: n.desc,
                                imageurl: n.icon,
                                landurl: n.link,
            ...
            $e = function (e) {
                ...
                return L(t, e), Ye(t, [{
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "default",
                            t = arguments[1];
                        if (this.setShareData(t), "weibo" !== (e = String(e).toLowerCase())) throw "qqfriend" === e ? h() : "qzone" === e ? b(): new Error("当前浏览器不支持此操作!");
                        d()
                    }
                }]), t
            }(Ce),
