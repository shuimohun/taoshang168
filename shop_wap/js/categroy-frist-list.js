$(function ()
{
    ...
    $.getJSON(ApiUrl + "?ctl=Goods_Cat&met=cat&typ=json&cat_parent_id=0", function (t)
    {
        console.info(t);
        var r = t.data;
    ...
    $("#categroy-cnt").on("click", ".category", function ()
    {
        ...
        $.getJSON(ApiUrl + "?ctl=Goods_Cat&met=tree&typ=json", {cat_parent_id: t}, function (e)
        {
            var t = e.data;
...
function get_brand_recommend()
{
    ...
    $.getJSON(ApiUrl + "?ctl=Goods_Brand&met=lists&typ=json", function (e)
    {
        var t = e.data;
        t.WapSiteUrl = WapSiteUrl;
