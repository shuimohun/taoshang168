$(function (){
    ...
    function initCartList(){
        ...
        $.ajax({
            url: ApiUrl + "?ctl=Points&met=pointsCart&typ=json",
            type: "GET",
            dataType: "json",
    ...
    function editPointsCart ( points_cart_id, quantity, _this ) {
        ...
        $.ajax({
            url: ApiUrl + "?ctl=Points&met=editPointsCart&typ=json",
            type: "POST",
            dataType: "json",
            data: param,
            success: function ( data ) {
    ...
    function removePointsCart ( points_cart_id, _this ) {
        ...
        $.ajax({
            url: ApiUrl + "?ctl=Points&met=removePointsCart&typ=json",
            type: "POST",
            dataType: "json",
            data: param,
            success: function ( data ) {
    ...
    function calculatePoints() {
        ...
        $(".nctouch-cart-bottom").find("em").text( sumPoints + "金蛋" );
