$(function ()
{
   /* var e = getCookie("key");
    ...
    $.getJSON(ApiUrl + "?act=connect&op=get_state&t=connect_sms_reg", function (e)
    {
        if (e.datas != "0")
        {
            $(".register-tab").show()
    ...
    $("#registerbtn").click(function ()
    {
        ...
        if ($.sValid())
        {
            ...
            $.ajax({
                type: "post",
                url: UCenterApiUrl + "?ctl=Login&met=register&typ=json",
    ...
    $("#refister_mobile_btn").click(function(){
        ...
        {
            var ajaxurl = UCenterApiUrl + '?ctl=Login&met=regCode&typ=json&mobile='+mobile;
            $.ajax({
                type: "POST",
                url: ajaxurl,
                dataType: "json",
