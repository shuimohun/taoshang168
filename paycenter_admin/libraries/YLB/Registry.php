...
class YLB_Registry extends ArrayObject
{
    /**
     * Class name of the singleton registry object.
     * @var string
     */
    private static $_instanceClassName = 'YLB_Registry';
     ...
     *
     * @param YLB_Registry $registry An object instance of type YLB_Registry,
     *   or a subclass.
     * @return void
     * @throws Exception if registry is already initialized.
     */
    public static function setInstance(YLB_Registry $registry)
    {
        if (self::$_instance !== null) {
     ...
     */
    public static function setClassName($registryClassName = 'YLB_Registry')
    {
        if (self::$_instance !== null) {
            throw new Exception('Registry is already initialized');
        }
     ...
     *
     * This method can be called from an object of type YLB_Registry, or it
