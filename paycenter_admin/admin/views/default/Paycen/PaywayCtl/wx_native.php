  ...
  <div class="ilodate">支付设置（修改）</div>
    <div class="para-item">
		...
		<input type="hidden" name="payment_channel_id" id="payment_channel_id" value="<?php echo $payways['payment_channel_id']; ?>">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_account">微信公众号身份:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="appid" id="appid" value="<?php echo $list_config['appid']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_key">受理商ID:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="mchid" id="mchid" value="<?php echo $list_config['mchid']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_partner">商户支付密钥:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="key" id="key" value="<?php echo $list_config['key']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_partner">开发模式下的秘钥:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="appsecret" id="appsecret" value="<?php echo $list_config['appsecret']; ?>" class="ui-input"  />
				</div>
			</li>·
		</ul>
	</div>
