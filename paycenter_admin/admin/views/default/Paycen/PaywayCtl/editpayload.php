  ...
  <div class="ilodate">支付设置（修改）</div>
    <div class="para-item">
		<ul class="mod-form-rows" id="establish-form">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_name">开启邮箱:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="payment_channel_config" id="payment_channel_config" value="<?php echo $list_config['alipay_account']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config">密钥:</label>
				</div>
				<div class="ctn-wrap">
					<input type="text" name="payment_channel_config" id="payment_channel_config" value="" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
...
<script>
	$('#submit').click(function(event){
		...
		$.post("./index.php?ctl=Paycen_Payway&met=editpays",{"payment_channel_code":payment_channel_code,"payment_channel_name":payment_channel_name},function(data)
		{
			console.info(data);
			if(data.status == 200){
				alert("提交成功");
