    ...
    <div class="para-item">
		...
		<input type="hidden" name="payment_channel_id" id="payment_channel_id" value="<?php echo $payways['payment_channel_id']; ?>">
			...
			<li class="row-item">
				...
				<div class="ctn-wrap">
					<input type="text" name="alipay_account" id="alipay_account" value="<?php echo $list_config['alipay_account']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
				...
				<div class="ctn-wrap">
					<input type="text" name="alipay_key" id="alipay_key" value="<?php echo $list_config['alipay_key']; ?>" class="ui-input"  />
				</div>
			</li>
			<li class="row-item">
				<div class="label-wrap">
				...
				<div class="ctn-wrap">
					<input type="text" name="alipay_partner" id="alipay_partner" value="<?php echo $list_config['alipay_partner']; ?>" class="ui-input"  />
				</div>
			</li>·
		</ul>
	</div>
...
<script>
	$('#submit').click(function(event){
		...
		var payment_channel_status = $('.status input[name="payment_channel_status"]:checked ').val();
		var payment_channel_name = $('#payment_channel_name').val();
		var payment_channel_config_alipay_account = $('#alipay_account').val();
		var payment_channel_config_alipay_key = $('#alipay_key').val();
		var payment_channel_config_alipay_partner = $('#alipay_partner').val();
		//alert(payment_channel_config_alipay_partner);
		$.post("./index.php?ctl=Paycen_Payway&met=editPayLoad",{"payment_channel_id":payment_channel_id,"payment_channel_code":payment_channel_code,"payment_channel_status":payment_channel_status,"payment_channel_name":payment_channel_name,"alipay_account":payment_channel_config_alipay_account,"alipay_key":payment_channel_config_alipay_key,"alipay_partner":payment_channel_config_alipay_partner},function(data)
		{
			console.info(data);
			if(data.status == 200){
				alert("提交成功");
