...
<body>
       ...
       <div class="ncap-form-default">
           <input id="id"  name="id" value="<?=$data['id']?>" class="ui-input w200" type="hidden"/>
              <dl class="row">
                <dt class="tit">
                    <label for="name">* 名称</label>
                </dt>
                <dd class="opt">
                    <input id="name"  name="name" value="<?=$data['name']?>" class="ui-input w200" type="text"/>
                </dd>
              </dl>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                        <input id="fee_rates"  name="fee_rates" value="<?=$data['fee_rates']?>" class="ui-input w200" type="text"/>
                    <p class="notic">单位为%</p>
                </dd>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                     <input id="fee_min"  name="fee_min" value="<?=$data['fee_min']?>" class="ui-input w200" type="text"/>
                </dd>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                     <input id="fee_max"  name="fee_max" value="<?=$data['fee_max']?>" class="ui-input w200" type="text"/>
                </dd>
