  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
          <li><a class="current"><span>提现申请</span></a></li>
          <li><a href="index.php?ctl=Paycen_PayService&met=index"><span>服务费配置</span></a></li>
      </ul>
    </div>
  </div>
...
<script src="./admin/static/default/js/controllers/paywithdraw/paywithdraw_list.js"></script>
<?php
