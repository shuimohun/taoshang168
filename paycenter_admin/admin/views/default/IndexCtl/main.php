...
<!--					<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Goods_WarehouseSku"><span></span>库存盘点</a>-->
				</li>
				<li class="storage-inventory">
...
<!--					<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Goods_WarehouseSku"><span></span>库存盘点</a>-->
	...
	<!--<div class="col-extra">
		<div class="extra-wrap">
			...
			<div class="list">
				<ul>
					<li><a tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Goods_Base">商品管理</a></li>
					<li><a tabid="setting-customerList" data-right="BU_QUERY" tabTxt="客户管理" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Member_Base">客户管理</a></li>
					<li><a tabid="setting-vendorList" data-right="PUR_QUERY" tabTxt="供应商管理" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Vendor_Base">供应商管理</a></li>
					<li><a tabid="sales-salesList" data-right="SA_QUERY" tabTxt="销货记录" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Sale_Bill&met=indexList">销售记录</a></li>
					<li><a tabid="purchase-salesList" data-right="PU_QUERY" tabTxt="采购记录" parentOpen="true" rel="pageTab" href="./erp.php?ctl=Purchase_Bill&met=purchaseList">采购记录</a></li>
					<li><a href="./erp.php?ctl=Finance_ReceiptBill&met=manage" rel="pageTab" tabid="money-receiptList" tabTxt="收款记录" data-right="RECEIPT_QUERY" parentOpen="true">收款记录</a></li>
					<li><a href="./erp.php?ctl=Finance_PaymentBill&met=manage" rel="pageTab" tabid="money-paymentList" tabTxt="付款记录" data-right="PAYMENT_QUERY" parentOpen="true">付款记录</a></li>
