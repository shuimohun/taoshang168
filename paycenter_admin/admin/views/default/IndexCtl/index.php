...
<!-- 			<li><a href="<?= YLB_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href">广告系统</i></a></li>
				<li><a href="<?= YLB_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href">大数据</i></a></li>
			...
			<div class="nav-wrap hidden cf"><!--订单-->
				...
				<div id="sub-nav">
					<ul class="cur cf" id="setting-base">
                        ...
                        <li>
                        <i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Config&met=update" rel="pageTab" tabid="sale_order_manage" tabtxt="update">升级管理</a>
                        </li>
					</ul>
					...
					<ul class="cf" id="setting-manage">
                        ...
                        <li>
                            <i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayInfo&met=paycard" rel="pageTab" tabid="Paycen_PayInfo" tabtxt="银行卡认证">银行卡认证</a>
                        </li>
					</ul>
