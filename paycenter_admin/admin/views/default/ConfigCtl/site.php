    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=site&config_type%5B%5D=site"><span>站点设置</span></a></li>
				...
				<li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=mobileAccount&config_type%5B%5D=mobile&config_type%5B%5D=sms">短信设置</a></li>
                <li><a href="<?= YLB_Registry::get('url') ?>?ctl=Config&met=seo&config_type%5B%5D=seo"><span>SEO设置</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
