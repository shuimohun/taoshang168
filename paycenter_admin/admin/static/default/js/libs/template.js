    ...
    var o = function (e) {
        ...
        i = function () {
            ...
            return function (t, o, i) {
                ...
                function s(e) {
                    var n;
                    'print' === e ? n = T : 'include' === e ? (v.$include = r.$include, n = O)  : (n = '$data.' + e, r.hasOwnProperty(e) && (v[e] = r[e], n = 0 === e.indexOf('$') ? '$helpers.' + e : n + '===undefined?$helpers.' + e + ':' + n)),
                        w += e + '=' + n + ','
                }
                function p(e) {
                ...
                e(g.split(f), function (e) {
                    ...
                    g = h,
                i && (g = 'try{' + g + '}catch(e){' + 'throw {' + 'id:$id,' + 'name:\'Render Error\',' + 'message:e.message,' + 'line:$line,' + 'source:' + p(o) + '.split(/\\n/)[$line-1].replace(/^[\\s\\t]+/,\'\')' + '};' + '}'),
                    g = w + E[0] + g + 'return new String(' + E[3] + ');';
                try {
