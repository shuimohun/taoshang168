...
var THISPAGE = {
    ...
    loadGrid: function() {
        ...
        var colModel = [{
            ...
            name: 'user_identity_face_logo',
            label: '证件照正面',
            width: 120,
            align: "center",
            "formatter": handle.imgFmt,
            classes: 'img_flied'
        }, {
            name: 'user_identity_face_logo',
            label: '手持身份证',
...
var handle = {
    ...
    imgFmt: function(val, opt, row) {
        if (val) {
            val = '<img  height="30" width="100" src="' + val + '" class="jqzoom" rel="'+val+'">';
        } else {
